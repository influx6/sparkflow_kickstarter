...
["canvas_basics", "canvas_basics.dart", , A, {
  ...
  main: [function() {
    ...
    canvas.boot$0().then$1(K.Funcs_tagDefer(K.Funcs_identity$closure(), 1, null).call$1("booting canvas test"));
...
["hub", "package:hub/src/hub.dart", , K, {
  ...
  Enums_nthFor: function(a) {
    if (!!J.getInterceptor(a).$isList)
      return new K.Enums_nthFor_closure(a);
    return;
  },
  Enums_eachSync: function(n, it, c) {
    return K.Enums_eachSyncList(n, it, c);
  },
  ...
  Enums_eachAsyncMap: function(a, iterator, complete) {
    ...
    for (t2 = new H.ListIterator(keys, keys.length, 0, null); t2.moveNext$0();) {
      ...
      if (t1.kill_0)
        break;
      iterator.call$4(a.$index(0, f), f, a, new K.Enums_eachAsyncMap_closure(t1, a, complete));
    }
  },
  Enums_eachSyncList: function(a, iterator, complete) {
    ...
    t1.step_0 = 0;
    t1.tapper_1 = null;
    fuse = new K.Enums_eachSyncList_closure(t1, a, iterator, complete, t2);
    t1.tapper_1 = new K.Enums_eachSyncList_closure0(fuse);
    return fuse.call$0();
  },
  Enums_merge: function(a, b, override) {
    var merged = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
    merged.addAll$1(0, a);
    b.forEach$1(0, new K.Enums_merge_closure(override, merged));
    return merged;
  },
  ...
  Funcs_tagDefer: function(n, m, fmt) {
    return new K.Funcs_tagDefer_closure(n, m, fmt);
  },
  ...
  Funcs_compose: function(n, m, args) {
    ...
    if (args === 4)
      return K.Funcs_base10Functionator(new K.Funcs_compose_closure2().call$2(n, m), 4);
    if (args === 5)
      return K.Funcs_base10Functionator(new K.Funcs_compose_closure3().call$2(n, m), 5);
    if (args === 6)
      return K.Funcs_base10Functionator(new K.Funcs_compose_closure4().call$2(n, m), 6);
    if (args === 7)
      return K.Funcs_base10Functionator(new K.Funcs_compose_closure5().call$2(n, m), 6);
    if (args === 8)
      return K.Funcs_base10Functionator(new K.Funcs_compose_closure6().call$2(n, m), 7);
    if (args === 9)
      return K.Funcs_base10Functionator(new K.Funcs_compose_closure7().call$2(n, m), 8);
    if (args === 10)
      return K.Funcs_base10Functionator(new K.Funcs_compose_closure8().call$2(n, m), 9);
  },
  Funcs_cycle: function(times, fn) {
    if (times <= 0)
      return;
    fn.call$1(times);
    return K.Funcs_cycle(times - 1, fn);
  },
  ...
  Enums_eachSyncList_closure: {
    ...
    call$0: function() {
      ...
      this.iterator_2.call$4(t1[t3], t3, t1, new K.Enums_eachSyncList__closure(t2, t1, this.complete_3, this.total_4));
    }
  },
  ...
  Mutator: {
    "^": "Distributor0;history,listeners,done,oncer,_switch,id,_hub$_locked",
    fireListeners$1: function(n) {
      var $history = [];
      $history.push(n);
      K.Enums_eachAsync(this.listeners, new K.Mutator_fireListeners_closure($history), new K.Mutator_fireListeners_closure0(this, $history));
    }
  },
  ...
  Condition: {
    ...
    fireConditions$1: function(n) {
      K.Enums_eachSync(this.conditions, new K.Condition_fireConditions_closure(n), new K.Condition_fireConditions_closure0(this, n));
    },
    fireDone$1: function(n) {
      K.Enums_eachSync(this.done, new K.Condition_fireDone_closure(n), null);
    },
    fireOnce$1: function(n) {
      K.Enums_eachSync(this.once, new K.Condition_fireOnce_closure(n), new K.Condition_fireOnce_closure0(this));
    }
  },
  ...
  Counter0: {
    "^": "Object;_hub$_count,handler",
    toString$0: function(_) {
      return "Counter: " + C.JSInt_methods.toString$0(this._hub$_count);
    }
  },
  State: {
    ...
    State$3: function(target, sets, $name) {
      var t1;
      this.name = K.Funcs_switchUnless($name, "StateObject");
      t1 = this.states;
      if ((t1.has$1("init") ? t1.storage.$index(0, "init") : null) == null)
        t1.add$2(0, "init", K._empty$closure());
      if ((t1.has$1("dinit") ? t1.storage.$index(0, "dinit") : null) == null)
        t1.add$2(0, "dinit", K._empty$closure());
      J.forEach$1$ax(sets, new K.State_closure(this));
    },
    static: {State$: function(target, sets, $name) {
        var t1 = new K.State(H.setRuntimeTypeInfo(new K.MapDecorator(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [null, null]), target, null, false);
  ...
  State_closure: {
    ...
    call$2: [function(n, k) {
      var t1 = this.this_0;
      t1.states.add$2(0, n, new K.State__closure(t1, k));
  ...
  StateManager: {
    ...
    close$0: [function(_) {
      this.store.storage.forEach$1(0, new K.StateManager_close_closure());
      this.store.storage.clear$0(0);
    }, "call$0", "get$close", 0, 0, 12],
    add$2: function(_, $name, m) {
      this.store.add$2(0, $name, K.State$(this.target, m, $name));
      return;
    },
    run$1: function($name) {
      var t1 = this.current;
  ...
  Funcs_tagDefer_closure: {
    ...
    call$1: function(tag) {
      return K.Funcs_tagPrint(tag, this.n_0, this.m_1, this.fmt_2, null, null);
    }
  },
...
["sparkflow", "package:sparkflow/src/core.dart", , S, {
  "^": "",
  ...
  Packet: {
    ...
    init$4: function($event, data, owner, portid) {
      ...
      this.add$2(0, "_lists", H.setRuntimeTypeInfo(new K.MapDecorator(P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, S.PacketList)), [null, null]));
      return this;
    },
    get$event: function() {
  ...
  SparkRegistry_addMutation_closure: {
    ...
    }, "call$1", "call$2", null, null, null, 0, 4, null, 17, 17, 84, 85, "call"]
  },
  SparkRegistryManager: {
    ...
    registerNS$1: function(namespace) {
      this.registery_groups.add$2(0, namespace.toLowerCase(), new S.SparkRegistry(new S.SparkGroups(new S.MassTree(new K.Switch(-1, H.setRuntimeTypeInfo([], [P.Function]), H.setRuntimeTypeInfo([], [P.Function])), P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)))));
    },
    has$1: function(nm) {
      var from, ne, t1, t2;
    ...
    generate$3: function(path, ops, a) {
      ...
      if (!this.registery_groups.has$1(J.toLowerCase$0$s(ne)))
        return;
      gp = K.Enums_nth(from, 1);
      id = K.Enums_nth(from, 2);
  ...
  toIP_closure: {
    ...
    call$1: [function(data) {
      ...
      if (!!J.getInterceptor(data).$isPacket)
        return data;
      d = K.Funcs_switchUnless(data, null);
  ...
  Socket: {
    ...
    bindSocket$2: function(a, bindEnding) {
      ...
      if (this.filter.has$2(a, S.socketFilter$closure()))
        return;
      bindEnding = K.Funcs_switchUnless(bindEnding, true);
      sub = H.setRuntimeTypeInfo(new K.MapDecorator(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [null, null]);
    ...
    }, "endStream$0", "call$1", "call$0", "get$endStream", 0, 2, 89, 17, 32],
    close$0: [function(_) {
      var t1;
      this.detachAll$0();
      t1 = this.streams;
    ...
    Socket$1: function(from, $M) {
      ...
      this.streams = new S.SocketStream(K.Hub_randomString(3, null), H.setRuntimeTypeInfo(new K.MapDecorator(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [null, null]), X.Streamable$(null, null));
      t1 = new F.dsListIterator(0, null, null, this.subscribers);
      t1.counter = new F.Counter(0, t1);
      this.filter = t1;
      this.dtconditions = H.setRuntimeTypeInfo(new K.Condition([], [], [], []), [null]);
      this.bgconditions = H.setRuntimeTypeInfo(new K.Condition([], [], [], []), [null]);
      this.egconditions = H.setRuntimeTypeInfo(new K.Condition([], [], [], []), [null]);
  ...
  Port: {
    ...
    beginGroup$2: function(data, alias) {
      this.handlePacket$4(K.Funcs_switchUnless(data, null), new S.Port_beginGroup_closure(this), "beginGroup", alias);
    },
    beginGroup$1: function(data) {
      return this.beginGroup$2(data, null);
    },
    endGroup$2: function(data, alias) {
      this.handlePacket$4(K.Funcs_switchUnless(data, null), new S.Port_endGroup_closure(this), "endGroup", alias);
    },
    ...
    bindSocket$3: function(v, alias, bindend) {
      ...
      t1 = this.aliases;
      if (t1._collection$_length === 0)
        this.counter._hub$_count = 0;
      sub = this.sparkflow$Port$socket.bindSocket$2(v, bindend);
      if (sub == null)
        return;
      t2 = ++this.counter._hub$_count;
    ...
    Port$3: function(id, meta, owner, $M) {
      var t1, t2, clone;
      t1 = K.Funcs_switchUnless(meta, P.LinkedHashMap_LinkedHashMap$_empty(null, null));
      t2 = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      t2.addAll$1(0, t1);
      this.meta = H.setRuntimeTypeInfo(new K.MapDecorator(t2), [null, null]);
      this.counter = new K.Counter0(0, this);
      t2 = H.setRuntimeTypeInfo(new S.Socket(new S.closure1(), new S.closure2(), X.Distributor$("streamable-streamcontinue", null), X.Distributor$("streamable-streamhalt", null), K.Hub_randomString(5, null), F.dsList_create(null), X.Distributor$("streamable-socketsub", null), X.Distributor$("streamable-socketUnsub", null), null, null, null, null, null, null, null, null, null, null), [null]);
      ...
      clone = H.setRuntimeTypeInfo(new K.Mutator([], H.setRuntimeTypeInfo([], [P.Function]), H.setRuntimeTypeInfo([], [P.Function]), H.setRuntimeTypeInfo([], [P.Function]), new K.Switch(-1, H.setRuntimeTypeInfo([], [P.Function]), H.setRuntimeTypeInfo([], [P.Function])), "clone-transformer", false), [null]);
  ...
  Port_tapData_closure: {
    ...
    call$1: [function(p) {
      ...
      if (!J.getInterceptor(p).$isPacket) {
        ...
        t2 = p;
      K.Funcs_when(J.$eq(t2.get$event(), "data"), new S.Port_tapData__closure(t1, this.n_2), null);
  ...
  Network: {
    ...
    link$7: function(nport, com, inport, sid, ve, bf, inverse) {
      ...
      if (this.networkPorts.hasPort$1(nport) !== true)
        return;
      t1.inverse_0 = K.Funcs_switchUnless(t1.inverse_0, false);
    ...
    doBinding$7: function(from, fp, to, tp, sid, ve, f) {
      var t1, t2, t3;
      t1 = from === to && to !== "*";
      K.Funcs_when(t1, new S.Network_doBinding_closure(this, from, fp, to, tp, sid, ve), null);
      t1 = from === "*";
      t2 = t1 && to === "*";
      K.Funcs_when(t2, new S.Network_doBinding_closure0(this, fp, tp, sid, ve), null);
      t2 = !t1;
      t3 = t2 && to !== "*";
      K.Funcs_when(t3, new S.Network_doBinding_closure1(this, from, fp, to, tp, sid, ve, f), null);
      t1 = t1 && to !== "*";
      K.Funcs_when(t1, new S.Network_doBinding_closure2(this, fp, to, tp, sid, ve, f), null);
      t1 = t2 && to === "*";
      K.Funcs_when(t1, new S.Network_doBinding_closure3(this, from, fp, tp, sid, ve, f), null);
    },
    ...
    Network$2: function(id, desc) {
      var t1, t2;
      this.networkPorts = new S.PortManager(H.setRuntimeTypeInfo(new K.MapDecorator(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [null, null]), this);
      t1 = this.components;
      ...
      t1 = t1.add$1(0, new S.PlaceHolder("placeholder", K.Hub_randomString(7, null)));
      this.placeholder = t1;
      this.uuidRegister.add$2(0, "placeholder", J.get$data$x(t1).get$uuid());
      t1 = new K.StateManager(this, null, null);
      t1.store = H.setRuntimeTypeInfo(new K.MapDecorator(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [null, null]);
    ...
    static: {Network$: function(id, desc) {
        ...
        t4 = H.setRuntimeTypeInfo(new K.MapDecorator(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [null, null]);
        t5 = K.Hub_randomString(5, null);
        ...
        t23.addAll$1(0, t22);
        t23 = H.setRuntimeTypeInfo(new K.MapDecorator(t23), [null, null]);
  ...
  closure: {
    ...
    call$3: [function(key, node, arc) {
      if (J.get$data$x(node).get$uuid() === key)
        return node;
      return;
    }, "call$3", null, 6, 0, null, 58, 91, 92, "call"]
  },
  closure0: {
    "^": "Closure:93;",
    call$3: [function(key, node, arc) {
  ...
  ConnectionMeta: {
    ...
    filterUUIDPort$3: function(a, port, sockid) {
      return K.Enums_filterKeys(a, new S.ConnectionMeta_filterUUIDPort_closure(port, sockid), null);
    },
    ...
    addConnection$4: function(ports, uuid, port, sockid) {
      var result, uuidp;
      if (!this.has$1(ports))
        this.add$2(0, ports, H.setRuntimeTypeInfo(new K.MapDecorator(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [null, null]));
      ...
      K.Funcs_when(this.filterUUIDPort$3(uuidp, port, sockid).length === 0, new S.ConnectionMeta_addConnection_closure(port, sockid, uuidp), null);
    },
    removeConnection$4: function(ports, uuid, port, sockid) {
      ...
      uuidp = result.get$1(uuid);
      K.Funcs_when(uuidp != null, new S.ConnectionMeta_removeConnection_closure(uuid, result, item, uuidp), null);
    },
    $asMapDecorator: function() {
      return [null, null];
    }
  ...
  PortGroup: {
    ...
    _addPort$3: function($name, meta, g) {
      ...
      if (t1.has$1($name))
        return;
      port = g.call$3($name, K.Enums_merge(meta, this.defaults, true), this.owner);
  ...
  PortGroup_addInport_closure: {
    "^": "Closure:93;",
    call$3: function(a, b, c) {
      var t1 = new S.Inport(C.C_InPortType, K.Hub_randomString(5, null), P.LinkedHashMap_LinkedHashMap(null, null, null, null, null), null, null, c, null, null, null, null);
  ...
  PortGroup_addOutPort_closure: {
    "^": "Closure:93;",
    call$3: function(a, b, c) {
      var t1 = new S.Outport(C.C_OutportType, K.Hub_randomString(5, null), P.LinkedHashMap_LinkedHashMap(null, null, null, null, null), null, null, c, null, null, null, null);
      t1.Port$3(a, b, c, null);
      return t1;
    }
  },
  ...
  PortManager: {
    ...
    createSpace$1: function(id) {
      ...
      if (t1.has$1(id))
        return;
      t2 = this.owner;
      t1.add$2(0, id, new S.PortGroup(P.LinkedHashMap_LinkedHashMap$_literal(["schema", "dynamic", "datatype", "dynamic", "engine", "sparkflow"], null, null), X.Streamable$(null, null), H.setRuntimeTypeInfo(new K.MapDecorator(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [null, null]), t2, id));
    },
  ...
  Component: {
    ...
    Component$1: function(id) {
      var t1;
      this.comPorts = new S.PortManager(H.setRuntimeTypeInfo(new K.MapDecorator(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [null, null]), this);
    ...
    static: {Component_create: [function(id) {
        ...
        t9.addAll$1(0, t8);
        t9 = new S.Component(t1, t2, t3, t4, t5, null, null, null, null, t7, H.setRuntimeTypeInfo(new K.MapDecorator(t9), [null, null]), H.setRuntimeTypeInfo(new K.MapDecorator(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [null, null]), H.setRuntimeTypeInfo(new K.MapDecorator(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [null, null]), H.setRuntimeTypeInfo(new K.MapDecorator(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [null, null]), null);
  ...
  Component_closure8: {
    ...
    call$1: [function(e) {
      ...
      t1 = J.getInterceptor$asx(e);
      t2 = this.this_0;
      K.Funcs_when(J.$eq(t1.$index(e, "type"), "bind"), new S.Component__closure(t2, e), null);
      K.Funcs_when(J.$eq(t1.$index(e, "type"), "unbind"), new S.Component__closure0(t2, e), null);
    }, "call$1", null, 2, 0, null, 1, "call"]
  },
  Component__closure: {
  ...
  MassTree: {
    ...
    destroy$1: function(key) {
      if (this.canDestroy._hub$_state !== 1)
        return;
      return K.MapDecorator.prototype.destroy$1.call(this, key);
    },
    $asMapDecorator: function() {
      return [null, null];
    }
  ...
  ComponentGroup_add_closure: {
    "^": "Closure:98;generator_0,path_1",
    call$2: [function(ops, named) {
      var com = H.Primitives_applyFunction(this.generator_0, K.Funcs_switchUnless(ops, []), P.Function__toMangledNames(K.Hub_encryptNamedArguments(K.Funcs_switchUnless(named, P.LinkedHashMap_LinkedHashMap$_empty(null, null)))));
  ...
  SparkGroups: {
    ...
    addGroup$1: function(handle) {
      ...
      if (t1.has$1(handle))
        return;
      t1.add$2(0, handle, new S.ComponentGroup(H.setRuntimeTypeInfo(new K.MapDecorator(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [null, null]), K.Hub_randomString(7, null), handle));
    },
    ...
    hasGroupString$1: function(path) {
      ...
      if (from.length < 2)
        return;
      group = K.Enums_nth(from, 0);
      $name = K.Enums_nth(from, 1);
    ...
    getGroupFromString$1: function(path) {
      ...
      if (this.groupSets.has$1(J.toLowerCase$0$s(C.JSArray_methods.get$first(from))))
        return this.getGroup$1(K.Enums_nth(from, 0)).get$1(K.Enums_nth(from, 1));
      return;
    },
...
["streamable", "package:streamable/streamable.dart", , X, {
  ...
  Streamable: {
    ...
    close$0: [function(_) {
      ...
      t1 = this.initd;
      t1._locked = true;
      this.transformer._hub$_locked = true;
      t2 = this.drained;
      t2._locked = true;
      t3 = this.ended;
      t3._locked = true;
    ...
    static: {Streamable$: function(m, $T) {
        var t1 = H.setRuntimeTypeInfo(new X.Streamable(F.dsList_create(null), H.setRuntimeTypeInfo(new K.Mutator([], H.setRuntimeTypeInfo([], [P.Function]), H.setRuntimeTypeInfo([], [P.Function]), H.setRuntimeTypeInfo([], [P.Function]), new K.Switch(-1, H.setRuntimeTypeInfo([], [P.Function]), H.setRuntimeTypeInfo([], [P.Function])), "streamble-transformer", false), [null]), X.Distributor$("streamable-emitInitiation", null), X.Distributor$("streamable-drainer", null), X.Distributor$("streamable-close", null), X.Distributor$("streamable-close", null), X.Distributor$("streamable-resume", null), X.Distributor$("streamable-pause", null), X.Distributor$("streamable-listeners", null), X.Distributor$("streamable-listenersAdd", null), X.Distributor$("streamable-listenersRemoved", null), null, null, null, null, false, null, null), [$T]);
        t1.Streamable$1(m, $T);
        return t1;
      }}
  },
  ...
  Subscriber: {
    ...
    static: {Subscriber$: function(source, $T) {
        var t1 = H.setRuntimeTypeInfo(new X.Subscriber(X.Streamable$(null, null), source, null, H.setRuntimeTypeInfo(new K.MapDecorator(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [null, null])), [$T]);
...
Isolate.$lazy($, "registry", "Sparkflow_registry", "get$Sparkflow_registry", function() {
  var t1 = new S.SparkRegistryManager(H.setRuntimeTypeInfo(new K.MapDecorator(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [null, null]));
...
function dart_precompiled($collectedClasses) {
  ...
  function CanvasBasics_register_closure() {
  }
  CanvasBasics_register_closure.builtin$cls = "CanvasBasics_register_closure";
  if (!"name" in CanvasBasics_register_closure)
    CanvasBasics_register_closure.name = "CanvasBasics_register_closure";
  $desc = $collectedClasses.CanvasBasics_register_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasBasics_register_closure.prototype = $desc;
  function CanvasBasics_register__closure() {
  }
  CanvasBasics_register__closure.builtin$cls = "CanvasBasics_register__closure";
  if (!"name" in CanvasBasics_register__closure)
    CanvasBasics_register__closure.name = "CanvasBasics_register__closure";
  $desc = $collectedClasses.CanvasBasics_register__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasBasics_register__closure.prototype = $desc;
  function CanvasBasics_register___closure4() {
  }
  CanvasBasics_register___closure4.builtin$cls = "CanvasBasics_register___closure4";
  if (!"name" in CanvasBasics_register___closure4)
    CanvasBasics_register___closure4.name = "CanvasBasics_register___closure4";
  $desc = $collectedClasses.CanvasBasics_register___closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasBasics_register___closure4.prototype = $desc;
  function CanvasBasics_register___closure5(box_0, shell_2) {
    this.box_0 = box_0;
    this.shell_2 = shell_2;
  }
  CanvasBasics_register___closure5.builtin$cls = "CanvasBasics_register___closure5";
  if (!"name" in CanvasBasics_register___closure5)
    CanvasBasics_register___closure5.name = "CanvasBasics_register___closure5";
  $desc = $collectedClasses.CanvasBasics_register___closure5;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasBasics_register___closure5.prototype = $desc;
  function CanvasBasics_register__closure0() {
  }
  CanvasBasics_register__closure0.builtin$cls = "CanvasBasics_register__closure0";
  if (!"name" in CanvasBasics_register__closure0)
    CanvasBasics_register__closure0.name = "CanvasBasics_register__closure0";
  $desc = $collectedClasses.CanvasBasics_register__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasBasics_register__closure0.prototype = $desc;
  function CanvasBasics_register___closure() {
  }
  CanvasBasics_register___closure.builtin$cls = "CanvasBasics_register___closure";
  if (!"name" in CanvasBasics_register___closure)
    CanvasBasics_register___closure.name = "CanvasBasics_register___closure";
  $desc = $collectedClasses.CanvasBasics_register___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasBasics_register___closure.prototype = $desc;
  function CanvasBasics_register___closure0() {
  }
  CanvasBasics_register___closure0.builtin$cls = "CanvasBasics_register___closure0";
  if (!"name" in CanvasBasics_register___closure0)
    CanvasBasics_register___closure0.name = "CanvasBasics_register___closure0";
  $desc = $collectedClasses.CanvasBasics_register___closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasBasics_register___closure0.prototype = $desc;
  function CanvasBasics_register___closure1() {
  }
  CanvasBasics_register___closure1.builtin$cls = "CanvasBasics_register___closure1";
  if (!"name" in CanvasBasics_register___closure1)
    CanvasBasics_register___closure1.name = "CanvasBasics_register___closure1";
  $desc = $collectedClasses.CanvasBasics_register___closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasBasics_register___closure1.prototype = $desc;
  function CanvasBasics_register___closure2(box_1, shell_3) {
    this.box_1 = box_1;
    this.shell_3 = shell_3;
  }
  CanvasBasics_register___closure2.builtin$cls = "CanvasBasics_register___closure2";
  if (!"name" in CanvasBasics_register___closure2)
    CanvasBasics_register___closure2.name = "CanvasBasics_register___closure2";
  $desc = $collectedClasses.CanvasBasics_register___closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasBasics_register___closure2.prototype = $desc;
  function CanvasBasics_register___closure3(box_1) {
    this.box_1 = box_1;
  }
  CanvasBasics_register___closure3.builtin$cls = "CanvasBasics_register___closure3";
  if (!"name" in CanvasBasics_register___closure3)
    CanvasBasics_register___closure3.name = "CanvasBasics_register___closure3";
  $desc = $collectedClasses.CanvasBasics_register___closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasBasics_register___closure3.prototype = $desc;
  ...
  function Counter(_count, handler) {
    this._count = _count;
    this.handler = handler;
  }
  Counter.builtin$cls = "Counter";
  if (!"name" in Counter)
    Counter.name = "Counter";
  $desc = $collectedClasses.Counter;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Counter.prototype = $desc;
  function DS(marked) {
    this.marked = marked;
  }
  DS.builtin$cls = "DS";
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  DS.prototype = $desc;
  DS.prototype.get$marked = function() {
    return this.marked;
  };
  function dsFilter() {
  }
  dsFilter.builtin$cls = "dsFilter";
  if (!"name" in dsFilter)
    dsFilter.name = "dsFilter";
  $desc = $collectedClasses.dsFilter;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsFilter.prototype = $desc;
  function dsAbstractNode(data) {
    this.data = data;
  }
  dsAbstractNode.builtin$cls = "dsAbstractNode";
  if (!"name" in dsAbstractNode)
    dsAbstractNode.name = "dsAbstractNode";
  $desc = $collectedClasses.dsAbstractNode;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsAbstractNode.prototype = $desc;
  dsAbstractNode.prototype.get$data = function(receiver) {
    return this.data;
  };
  function dsAbstractList() {
  }
  dsAbstractList.builtin$cls = "dsAbstractList";
  if (!"name" in dsAbstractList)
    dsAbstractList.name = "dsAbstractList";
  $desc = $collectedClasses.dsAbstractList;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsAbstractList.prototype = $desc;
  function dsGSearcher() {
  }
  dsGSearcher.builtin$cls = "dsGSearcher";
  if (!"name" in dsGSearcher)
    dsGSearcher.name = "dsGSearcher";
  $desc = $collectedClasses.dsGSearcher;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsGSearcher.prototype = $desc;
  function dsGArc(node, weight) {
    this.node = node;
    this.weight = weight;
  }
  dsGArc.builtin$cls = "dsGArc";
  if (!"name" in dsGArc)
    dsGArc.name = "dsGArc";
  $desc = $collectedClasses.dsGArc;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsGArc.prototype = $desc;
  dsGArc.prototype.get$node = function() {
    return this.node;
  };
  dsGArc.prototype.get$weight = function() {
    return this.weight;
  };
  function dsGNode(arcs, core0$dsGNode$data) {
    this.arcs = arcs;
    this.core0$dsGNode$data = core0$dsGNode$data;
  }
  dsGNode.builtin$cls = "dsGNode";
  if (!"name" in dsGNode)
    dsGNode.name = "dsGNode";
  $desc = $collectedClasses.dsGNode;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsGNode.prototype = $desc;
  dsGNode.prototype.get$arcs = function() {
    return this.arcs;
  };
  dsGNode.prototype.get$data = function(receiver) {
    return this.core0$dsGNode$data;
  };
  function dsAbstractGraph() {
  }
  dsAbstractGraph.builtin$cls = "dsAbstractGraph";
  if (!"name" in dsAbstractGraph)
    dsAbstractGraph.name = "dsAbstractGraph";
  $desc = $collectedClasses.dsAbstractGraph;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsAbstractGraph.prototype = $desc;
  function dsAbstractIterator(node) {
    this.node = node;
  }
  dsAbstractIterator.builtin$cls = "dsAbstractIterator";
  if (!"name" in dsAbstractIterator)
    dsAbstractIterator.name = "dsAbstractIterator";
  $desc = $collectedClasses.dsAbstractIterator;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsAbstractIterator.prototype = $desc;
  dsAbstractIterator.prototype.get$node = function() {
    return this.node;
  };
  function dsAbstractIterator_moveNext_closure(this_0) {
    this.this_0 = this_0;
  }
  dsAbstractIterator_moveNext_closure.builtin$cls = "dsAbstractIterator_moveNext_closure";
  if (!"name" in dsAbstractIterator_moveNext_closure)
    dsAbstractIterator_moveNext_closure.name = "dsAbstractIterator_moveNext_closure";
  $desc = $collectedClasses.dsAbstractIterator_moveNext_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsAbstractIterator_moveNext_closure.prototype = $desc;
  function dsAbstractIterator_moveNext_closure0(this_1) {
    this.this_1 = this_1;
  }
  dsAbstractIterator_moveNext_closure0.builtin$cls = "dsAbstractIterator_moveNext_closure0";
  if (!"name" in dsAbstractIterator_moveNext_closure0)
    dsAbstractIterator_moveNext_closure0.name = "dsAbstractIterator_moveNext_closure0";
  $desc = $collectedClasses.dsAbstractIterator_moveNext_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsAbstractIterator_moveNext_closure0.prototype = $desc;
  function dsAbstractIterator_moveNext_closure1(n_2) {
    this.n_2 = n_2;
  }
  dsAbstractIterator_moveNext_closure1.builtin$cls = "dsAbstractIterator_moveNext_closure1";
  if (!"name" in dsAbstractIterator_moveNext_closure1)
    dsAbstractIterator_moveNext_closure1.name = "dsAbstractIterator_moveNext_closure1";
  $desc = $collectedClasses.dsAbstractIterator_moveNext_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsAbstractIterator_moveNext_closure1.prototype = $desc;
  function GraphFilter(searcher, processor, graph, _core0$_key, _future, _all) {
    this.searcher = searcher;
    this.processor = processor;
    this.graph = graph;
    this._core0$_key = _core0$_key;
    this._future = _future;
    this._all = _all;
  }
  GraphFilter.builtin$cls = "GraphFilter";
  if (!"name" in GraphFilter)
    GraphFilter.name = "GraphFilter";
  $desc = $collectedClasses.GraphFilter;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GraphFilter.prototype = $desc;
  function GraphFilter_filter_closure(this_0) {
    this.this_0 = this_0;
  }
  GraphFilter_filter_closure.builtin$cls = "GraphFilter_filter_closure";
  if (!"name" in GraphFilter_filter_closure)
    GraphFilter_filter_closure.name = "GraphFilter_filter_closure";
  $desc = $collectedClasses.GraphFilter_filter_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GraphFilter_filter_closure.prototype = $desc;
  function dsDepthFirst(root, processor, _end) {
    this.root = root;
    this.processor = processor;
    this._end = _end;
  }
  dsDepthFirst.builtin$cls = "dsDepthFirst";
  if (!"name" in dsDepthFirst)
    dsDepthFirst.name = "dsDepthFirst";
  $desc = $collectedClasses.dsDepthFirst;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsDepthFirst.prototype = $desc;
  function dsBreadthFirst(root, processor, _end) {
    this.root = root;
    this.processor = processor;
    this._end = _end;
  }
  dsBreadthFirst.builtin$cls = "dsBreadthFirst";
  if (!"name" in dsBreadthFirst)
    dsBreadthFirst.name = "dsBreadthFirst";
  $desc = $collectedClasses.dsBreadthFirst;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsBreadthFirst.prototype = $desc;
  function dsGraph(git, nodes, marked, bomb) {
    this.git = git;
    this.nodes = nodes;
    this.marked = marked;
    this.bomb = bomb;
  }
  dsGraph.builtin$cls = "dsGraph";
  if (!"name" in dsGraph)
    dsGraph.name = "dsGraph";
  $desc = $collectedClasses.dsGraph;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsGraph.prototype = $desc;
  function dsGraphArc(node, weight) {
    this.node = node;
    this.weight = weight;
  }
  dsGraphArc.builtin$cls = "dsGraphArc";
  if (!"name" in dsGraphArc)
    dsGraphArc.name = "dsGraphArc";
  $desc = $collectedClasses.dsGraphArc;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsGraphArc.prototype = $desc;
  function dsGraphNode(_dit, isUniq, arcs, core0$dsGNode$data, left, right, data, _mark) {
    this._dit = _dit;
    this.isUniq = isUniq;
    this.arcs = arcs;
    this.core0$dsGNode$data = core0$dsGNode$data;
  ...
  dsGraphNode.builtin$cls = "dsGraphNode";
  if (!"name" in dsGraphNode)
    dsGraphNode.name = "dsGraphNode";
  $desc = $collectedClasses.dsGraphNode;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsGraphNode.prototype = $desc;
  function dsGraphNode_addArc_closure(this_0, a_1, n_2) {
    this.this_0 = this_0;
    this.a_1 = a_1;
    this.n_2 = n_2;
  }
  dsGraphNode_addArc_closure.builtin$cls = "dsGraphNode_addArc_closure";
  if (!"name" in dsGraphNode_addArc_closure)
    dsGraphNode_addArc_closure.name = "dsGraphNode_addArc_closure";
  $desc = $collectedClasses.dsGraphNode_addArc_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsGraphNode_addArc_closure.prototype = $desc;
  function dsGraphNode_removeArc_closure(this_0) {
    this.this_0 = this_0;
  }
  dsGraphNode_removeArc_closure.builtin$cls = "dsGraphNode_removeArc_closure";
  if (!"name" in dsGraphNode_removeArc_closure)
    dsGraphNode_removeArc_closure.name = "dsGraphNode_removeArc_closure";
  $desc = $collectedClasses.dsGraphNode_removeArc_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsGraphNode_removeArc_closure.prototype = $desc;
  function dsGraphNode_arcFinder_closure(callback_0) {
    this.callback_0 = callback_0;
  }
  dsGraphNode_arcFinder_closure.builtin$cls = "dsGraphNode_arcFinder_closure";
  if (!"name" in dsGraphNode_arcFinder_closure)
    dsGraphNode_arcFinder_closure.name = "dsGraphNode_arcFinder_closure";
  $desc = $collectedClasses.dsGraphNode_arcFinder_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsGraphNode_arcFinder_closure.prototype = $desc;
  function dsIterator() {
  }
  dsIterator.builtin$cls = "dsIterator";
  if (!"name" in dsIterator)
    dsIterator.name = "dsIterator";
  $desc = $collectedClasses.dsIterator;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsIterator.prototype = $desc;
  function dsListIterator(_core0$_state, counter, node, ds) {
    this._core0$_state = _core0$_state;
    this.counter = counter;
    this.node = node;
    this.ds = ds;
  }
  dsListIterator.builtin$cls = "dsListIterator";
  if (!"name" in dsListIterator)
    dsListIterator.name = "dsListIterator";
  $desc = $collectedClasses.dsListIterator;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsListIterator.prototype = $desc;
  function dsList(_it, head, tail, maxSize, marked, bomb) {
    this._it = _it;
    this.head = head;
    this.tail = tail;
  ...
  dsList.builtin$cls = "dsList";
  if (!"name" in dsList)
    dsList.name = "dsList";
  $desc = $collectedClasses.dsList;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsList.prototype = $desc;
  function dsNode(core0$dsNode$left, core0$dsNode$right, left, right, data, _mark) {
    this.core0$dsNode$left = core0$dsNode$left;
    this.core0$dsNode$right = core0$dsNode$right;
    this.left = left;
    this.right = right;
    this.data = data;
    this._mark = _mark;
  }
  dsNode.builtin$cls = "dsNode";
  if (!"name" in dsNode)
    dsNode.name = "dsNode";
  $desc = $collectedClasses.dsNode;
  if ($desc instanceof Array)
    $desc = $desc[1];
  dsNode.prototype = $desc;
  ...
  function Enums_nthFor_closure(a_0) {
    this.a_0 = a_0;
  }
  Enums_nthFor_closure.builtin$cls = "Enums_nthFor_closure";
  if (!"name" in Enums_nthFor_closure)
    Enums_nthFor_closure.name = "Enums_nthFor_closure";
  $desc = $collectedClasses.Enums_nthFor_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Enums_nthFor_closure.prototype = $desc;
  function Enums_nthFor_closure0(a_1) {
    this.a_1 = a_1;
  }
  Enums_nthFor_closure0.builtin$cls = "Enums_nthFor_closure0";
  if (!"name" in Enums_nthFor_closure0)
    Enums_nthFor_closure0.name = "Enums_nthFor_closure0";
  $desc = $collectedClasses.Enums_nthFor_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Enums_nthFor_closure0.prototype = $desc;
  ...
  function Enums_eachSyncList_closure(box_0, a_1, iterator_2, complete_3, total_4) {
    this.box_0 = box_0;
    this.a_1 = a_1;
    this.iterator_2 = iterator_2;
    this.complete_3 = complete_3;
    this.total_4 = total_4;
  }
  Enums_eachSyncList_closure.builtin$cls = "Enums_eachSyncList_closure";
  if (!"name" in Enums_eachSyncList_closure)
    Enums_eachSyncList_closure.name = "Enums_eachSyncList_closure";
  $desc = $collectedClasses.Enums_eachSyncList_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Enums_eachSyncList_closure.prototype = $desc;
  function Enums_eachSyncList__closure(box_0, a_5, complete_6, total_7) {
    this.box_0 = box_0;
    this.a_5 = a_5;
    this.complete_6 = complete_6;
    this.total_7 = total_7;
  }
  Enums_eachSyncList__closure.builtin$cls = "Enums_eachSyncList__closure";
  if (!"name" in Enums_eachSyncList__closure)
    Enums_eachSyncList__closure.name = "Enums_eachSyncList__closure";
  $desc = $collectedClasses.Enums_eachSyncList__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Enums_eachSyncList__closure.prototype = $desc;
  function Enums_eachSyncList_closure0(fuse_8) {
    this.fuse_8 = fuse_8;
  }
  Enums_eachSyncList_closure0.builtin$cls = "Enums_eachSyncList_closure0";
  if (!"name" in Enums_eachSyncList_closure0)
    Enums_eachSyncList_closure0.name = "Enums_eachSyncList_closure0";
  $desc = $collectedClasses.Enums_eachSyncList_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Enums_eachSyncList_closure0.prototype = $desc;
  function Enums_merge_closure(override_0, merged_1) {
    this.override_0 = override_0;
    this.merged_1 = merged_1;
  }
  Enums_merge_closure.builtin$cls = "Enums_merge_closure";
  if (!"name" in Enums_merge_closure)
    Enums_merge_closure.name = "Enums_merge_closure";
  $desc = $collectedClasses.Enums_merge_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Enums_merge_closure.prototype = $desc;
  ...
  function Switch(_hub$_state, onOff, onOn) {
    this._hub$_state = _hub$_state;
    this.onOff = onOff;
    this.onOn = onOn;
  }
  ...
  function Distributor0(id) {
    this.id = id;
  }
  Distributor0.builtin$cls = "Distributor0";
  if (!"name" in Distributor0)
    Distributor0.name = "Distributor0";
  $desc = $collectedClasses.Distributor0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Distributor0.prototype = $desc;
  Distributor0.prototype.get$id = function(receiver) {
    return this.id;
  };
  ...
  function Mutator(history, listeners, done, oncer, _switch, id, _hub$_locked) {
    ...
    this.id = id;
    this._hub$_locked = _hub$_locked;
  }
  Mutator.builtin$cls = "Mutator";
  if (!"name" in Mutator)
    Mutator.name = "Mutator";
  $desc = $collectedClasses.Mutator;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Mutator.prototype = $desc;
  function Mutator_fireListeners_closure0(this_0, history_1) {
    this.this_0 = this_0;
    this.history_1 = history_1;
  }
  Mutator_fireListeners_closure0.builtin$cls = "Mutator_fireListeners_closure0";
  if (!"name" in Mutator_fireListeners_closure0)
    Mutator_fireListeners_closure0.name = "Mutator_fireListeners_closure0";
  $desc = $collectedClasses.Mutator_fireListeners_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Mutator_fireListeners_closure0.prototype = $desc;
  function Mutator_fireListeners_closure(history_2) {
    this.history_2 = history_2;
  }
  Mutator_fireListeners_closure.builtin$cls = "Mutator_fireListeners_closure";
  if (!"name" in Mutator_fireListeners_closure)
    Mutator_fireListeners_closure.name = "Mutator_fireListeners_closure";
  $desc = $collectedClasses.Mutator_fireListeners_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Mutator_fireListeners_closure.prototype = $desc;
  function Condition(history, conditions, done, once) {
    this.history = history;
    this.conditions = conditions;
    this.done = done;
    this.once = once;
  }
  Condition.builtin$cls = "Condition";
  if (!"name" in Condition)
    Condition.name = "Condition";
  $desc = $collectedClasses.Condition;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Condition.prototype = $desc;
  function Condition_fireConditions_closure(n_0) {
    this.n_0 = n_0;
  }
  Condition_fireConditions_closure.builtin$cls = "Condition_fireConditions_closure";
  if (!"name" in Condition_fireConditions_closure)
    Condition_fireConditions_closure.name = "Condition_fireConditions_closure";
  $desc = $collectedClasses.Condition_fireConditions_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Condition_fireConditions_closure.prototype = $desc;
  function Condition_fireConditions_closure0(this_1, n_2) {
    this.this_1 = this_1;
    this.n_2 = n_2;
  }
  Condition_fireConditions_closure0.builtin$cls = "Condition_fireConditions_closure0";
  if (!"name" in Condition_fireConditions_closure0)
    Condition_fireConditions_closure0.name = "Condition_fireConditions_closure0";
  $desc = $collectedClasses.Condition_fireConditions_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Condition_fireConditions_closure0.prototype = $desc;
  function Condition_fireDone_closure(n_0) {
    this.n_0 = n_0;
  }
  Condition_fireDone_closure.builtin$cls = "Condition_fireDone_closure";
  if (!"name" in Condition_fireDone_closure)
    Condition_fireDone_closure.name = "Condition_fireDone_closure";
  $desc = $collectedClasses.Condition_fireDone_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Condition_fireDone_closure.prototype = $desc;
  function Condition_fireOnce_closure(n_0) {
    this.n_0 = n_0;
  }
  Condition_fireOnce_closure.builtin$cls = "Condition_fireOnce_closure";
  if (!"name" in Condition_fireOnce_closure)
    Condition_fireOnce_closure.name = "Condition_fireOnce_closure";
  $desc = $collectedClasses.Condition_fireOnce_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Condition_fireOnce_closure.prototype = $desc;
  function Condition_fireOnce_closure0(this_1) {
    this.this_1 = this_1;
  }
  Condition_fireOnce_closure0.builtin$cls = "Condition_fireOnce_closure0";
  if (!"name" in Condition_fireOnce_closure0)
    Condition_fireOnce_closure0.name = "Condition_fireOnce_closure0";
  $desc = $collectedClasses.Condition_fireOnce_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Condition_fireOnce_closure0.prototype = $desc;
  ...
  MapDecorator.prototype.get$storage = function() {
    return this.storage;
  };
  function Counter0(_hub$_count, handler) {
    this._hub$_count = _hub$_count;
    this.handler = handler;
  }
  Counter0.builtin$cls = "Counter0";
  if (!"name" in Counter0)
    Counter0.name = "Counter0";
  $desc = $collectedClasses.Counter0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Counter0.prototype = $desc;
  function State(states, target, name, _active) {
    this.states = states;
    this.target = target;
    this.name = name;
  ...
  function State_closure(this_0) {
    this.this_0 = this_0;
  }
  State_closure.builtin$cls = "State_closure";
  if (!"name" in State_closure)
    State_closure.name = "State_closure";
  $desc = $collectedClasses.State_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  State_closure.prototype = $desc;
  function State__closure(this_1, k_2) {
    this.this_1 = this_1;
    this.k_2 = k_2;
  }
  State__closure.builtin$cls = "State__closure";
  if (!"name" in State__closure)
    State__closure.name = "State__closure";
  $desc = $collectedClasses.State__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  State__closure.prototype = $desc;
  function StateManager(target, store, current) {
    this.target = target;
    this.store = store;
    this.current = current;
  }
  StateManager.builtin$cls = "StateManager";
  if (!"name" in StateManager)
    StateManager.name = "StateManager";
  $desc = $collectedClasses.StateManager;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StateManager.prototype = $desc;
  StateManager.prototype.get$current = function() {
    return this.current;
  };
  function StateManager_close_closure() {
  }
  StateManager_close_closure.builtin$cls = "StateManager_close_closure";
  if (!"name" in StateManager_close_closure)
    StateManager_close_closure.name = "StateManager_close_closure";
  $desc = $collectedClasses.StateManager_close_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StateManager_close_closure.prototype = $desc;
  function Funcs_tagDefer_closure(n_0, m_1, fmt_2) {
    this.n_0 = n_0;
    this.m_1 = m_1;
    this.fmt_2 = fmt_2;
  }
  Funcs_tagDefer_closure.builtin$cls = "Funcs_tagDefer_closure";
  if (!"name" in Funcs_tagDefer_closure)
    Funcs_tagDefer_closure.name = "Funcs_tagDefer_closure";
  $desc = $collectedClasses.Funcs_tagDefer_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Funcs_tagDefer_closure.prototype = $desc;
  ...
  PacketList.builtin$cls = "PacketList";
  if (!"name" in PacketList)
    PacketList.name = "PacketList";
  $desc = $collectedClasses.PacketList;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PacketList.prototype = $desc;
  function Packet(storage) {
    this.storage = storage;
  }
  ...
  function SparkRegistry(groups) {
    this.groups = groups;
  }
  SparkRegistry.builtin$cls = "SparkRegistry";
  if (!"name" in SparkRegistry)
    SparkRegistry.name = "SparkRegistry";
  $desc = $collectedClasses.SparkRegistry;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SparkRegistry.prototype = $desc;
  function SparkRegistry_addMutation_closure(mutation_0, id_1) {
    this.mutation_0 = mutation_0;
    this.id_1 = id_1;
  }
  SparkRegistry_addMutation_closure.builtin$cls = "SparkRegistry_addMutation_closure";
  if (!"name" in SparkRegistry_addMutation_closure)
    SparkRegistry_addMutation_closure.name = "SparkRegistry_addMutation_closure";
  $desc = $collectedClasses.SparkRegistry_addMutation_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SparkRegistry_addMutation_closure.prototype = $desc;
  function SparkRegistryManager(registery_groups) {
    this.registery_groups = registery_groups;
  }
  SparkRegistryManager.builtin$cls = "SparkRegistryManager";
  if (!"name" in SparkRegistryManager)
    SparkRegistryManager.name = "SparkRegistryManager";
  $desc = $collectedClasses.SparkRegistryManager;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SparkRegistryManager.prototype = $desc;
  function FlowSocket() {
  }
  FlowSocket.builtin$cls = "FlowSocket";
  if (!"name" in FlowSocket)
    FlowSocket.name = "FlowSocket";
  $desc = $collectedClasses.FlowSocket;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FlowSocket.prototype = $desc;
  function FlowPort(socket) {
    this.socket = socket;
  }
  FlowPort.builtin$cls = "FlowPort";
  if (!"name" in FlowPort)
    FlowPort.name = "FlowPort";
  $desc = $collectedClasses.FlowPort;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FlowPort.prototype = $desc;
  FlowPort.prototype.get$socket = function() {
    return this.socket;
  };
  function FlowComponentAbstract() {
  }
  FlowComponentAbstract.builtin$cls = "FlowComponentAbstract";
  if (!"name" in FlowComponentAbstract)
    FlowComponentAbstract.name = "FlowComponentAbstract";
  $desc = $collectedClasses.FlowComponentAbstract;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FlowComponentAbstract.prototype = $desc;
  function FlowNetworkAbstract() {
  }
  FlowNetworkAbstract.builtin$cls = "FlowNetworkAbstract";
  if (!"name" in FlowNetworkAbstract)
    FlowNetworkAbstract.name = "FlowNetworkAbstract";
  $desc = $collectedClasses.FlowNetworkAbstract;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FlowNetworkAbstract.prototype = $desc;
  function FlowNetwork() {
  }
  FlowNetwork.builtin$cls = "FlowNetwork";
  if (!"name" in FlowNetwork)
    FlowNetwork.name = "FlowNetwork";
  $desc = $collectedClasses.FlowNetwork;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FlowNetwork.prototype = $desc;
  function FlowComponent(uuid) {
    this.uuid = uuid;
  }
  FlowComponent.builtin$cls = "FlowComponent";
  if (!"name" in FlowComponent)
    FlowComponent.name = "FlowComponent";
  $desc = $collectedClasses.FlowComponent;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FlowComponent.prototype = $desc;
  FlowComponent.prototype.get$uuid = function() {
    return this.uuid;
  };
  function toIP_closure(type_0, socket_1, packets_2) {
    this.type_0 = type_0;
    this.socket_1 = socket_1;
    this.packets_2 = packets_2;
  }
  toIP_closure.builtin$cls = "toIP_closure";
  if (!"name" in toIP_closure)
    toIP_closure.name = "toIP_closure";
  $desc = $collectedClasses.toIP_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  toIP_closure.prototype = $desc;
  function SocketStream(uuid, meta, stream) {
    this.uuid = uuid;
    this.meta = meta;
    this.stream = stream;
  }
  SocketStream.builtin$cls = "SocketStream";
  if (!"name" in SocketStream)
    SocketStream.name = "SocketStream";
  $desc = $collectedClasses.SocketStream;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SocketStream.prototype = $desc;
  SocketStream.prototype.get$uuid = function() {
    return this.uuid;
  };
  SocketStream.prototype.get$meta = function() {
    return this.meta;
  };
  function Socket(_headerPackets, _dataPackets, continued, halted, uuid, subscribers, onSocketSubscription, onSocketRemoval, bgconditions, egconditions, dtconditions, toBGIP, toEGIP, toDataIP, streams, from, to, filter) {
    this._headerPackets = _headerPackets;
    this._dataPackets = _dataPackets;
    this.continued = continued;
    this.halted = halted;
    this.uuid = uuid;
    this.subscribers = subscribers;
    this.onSocketSubscription = onSocketSubscription;
    this.onSocketRemoval = onSocketRemoval;
    this.bgconditions = bgconditions;
    this.egconditions = egconditions;
    this.dtconditions = dtconditions;
    this.toBGIP = toBGIP;
    this.toEGIP = toEGIP;
    this.toDataIP = toDataIP;
  ...
  Socket.prototype.get$uuid = function() {
    return this.uuid;
  };
  function closure1() {
  }
  ...
  function Socket_forceCondition_closure(n_0) {
    this.n_0 = n_0;
  }
  Socket_forceCondition_closure.builtin$cls = "Socket_forceCondition_closure";
  if (!"name" in Socket_forceCondition_closure)
    Socket_forceCondition_closure.name = "Socket_forceCondition_closure";
  $desc = $collectedClasses.Socket_forceCondition_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Socket_forceCondition_closure.prototype = $desc;
  function Port(uuid, meta, owner, sparkflow$Port$socket) {
    this.uuid = uuid;
    this.meta = meta;
    this.owner = owner;
    this.sparkflow$Port$socket = sparkflow$Port$socket;
  }
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Port.prototype = $desc;
  Port.prototype.get$uuid = function() {
    return this.uuid;
  };
  Port.prototype.get$meta = function() {
    return this.meta;
  };
  Port.prototype.get$owner = function() {
    return this.owner;
  };
  Port.prototype.get$socket = function() {
    return this.sparkflow$Port$socket;
  };
  function Port_handleAliasCall_closure(type_0, socket_1) {
    this.type_0 = type_0;
    this.socket_1 = socket_1;
  }
  Port_handleAliasCall_closure.builtin$cls = "Port_handleAliasCall_closure";
  if (!"name" in Port_handleAliasCall_closure)
    Port_handleAliasCall_closure.name = "Port_handleAliasCall_closure";
  $desc = $collectedClasses.Port_handleAliasCall_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Port_handleAliasCall_closure.prototype = $desc;
  function Port_send_closure(this_0) {
    this.this_0 = this_0;
  }
  Port_send_closure.builtin$cls = "Port_send_closure";
  if (!"name" in Port_send_closure)
    Port_send_closure.name = "Port_send_closure";
  $desc = $collectedClasses.Port_send_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Port_send_closure.prototype = $desc;
  function Port_beginGroup_closure(this_0) {
    this.this_0 = this_0;
  }
  Port_beginGroup_closure.builtin$cls = "Port_beginGroup_closure";
  if (!"name" in Port_beginGroup_closure)
    Port_beginGroup_closure.name = "Port_beginGroup_closure";
  $desc = $collectedClasses.Port_beginGroup_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Port_beginGroup_closure.prototype = $desc;
  function Port_endGroup_closure(this_0) {
    this.this_0 = this_0;
  }
  Port_endGroup_closure.builtin$cls = "Port_endGroup_closure";
  if (!"name" in Port_endGroup_closure)
    Port_endGroup_closure.name = "Port_endGroup_closure";
  $desc = $collectedClasses.Port_endGroup_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Port_endGroup_closure.prototype = $desc;
  function Port_tapData_closure(this_1, n_2) {
    this.this_1 = this_1;
    this.n_2 = n_2;
  }
  Port_tapData_closure.builtin$cls = "Port_tapData_closure";
  if (!"name" in Port_tapData_closure)
    Port_tapData_closure.name = "Port_tapData_closure";
  $desc = $collectedClasses.Port_tapData_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Port_tapData_closure.prototype = $desc;
  function Port_tapData__closure(box_0, n_3) {
    this.box_0 = box_0;
    this.n_3 = n_3;
  }
  Port_tapData__closure.builtin$cls = "Port_tapData__closure";
  if (!"name" in Port_tapData__closure)
    Port_tapData__closure.name = "Port_tapData__closure";
  $desc = $collectedClasses.Port_tapData__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Port_tapData__closure.prototype = $desc;
  function InPortType() {
  }
  InPortType.builtin$cls = "InPortType";
  if (!"name" in InPortType)
    InPortType.name = "InPortType";
  $desc = $collectedClasses.InPortType;
  if ($desc instanceof Array)
    $desc = $desc[1];
  InPortType.prototype = $desc;
  function OutportType() {
  }
  OutportType.builtin$cls = "OutportType";
  if (!"name" in OutportType)
    OutportType.name = "OutportType";
  $desc = $collectedClasses.OutportType;
  if ($desc instanceof Array)
    $desc = $desc[1];
  OutportType.prototype = $desc;
  function Inport(portType, uuid, aliases, counter, meta, owner, sparkflow$Port$socket, aliasFilter, _transformer, socket) {
  ...
  Inport.builtin$cls = "Inport";
  if (!"name" in Inport)
    Inport.name = "Inport";
  $desc = $collectedClasses.Inport;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Inport.prototype = $desc;
  function Outport(portType, uuid, aliases, counter, meta, owner, sparkflow$Port$socket, aliasFilter, _transformer, socket) {
    this.portType = portType;
    this.uuid = uuid;
    this.aliases = aliases;
    this.counter = counter;
  ...
  Outport.builtin$cls = "Outport";
  if (!"name" in Outport)
    Outport.name = "Outport";
  $desc = $collectedClasses.Outport;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Outport.prototype = $desc;
  function PlaceHolder(id, uuid) {
    this.id = id;
    this.uuid = uuid;
  }
  PlaceHolder.builtin$cls = "PlaceHolder";
  if (!"name" in PlaceHolder)
    PlaceHolder.name = "PlaceHolder";
  $desc = $collectedClasses.PlaceHolder;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PlaceHolder.prototype = $desc;
  PlaceHolder.prototype.get$id = function(receiver) {
    return this.id;
  };
  PlaceHolder.prototype.get$uuid = function() {
    return this.uuid;
  };
  function FutureCompiler(futures, futureIterator) {
    this.futures = futures;
    this.futureIterator = futureIterator;
  }
  FutureCompiler.builtin$cls = "FutureCompiler";
  if (!"name" in FutureCompiler)
    FutureCompiler.name = "FutureCompiler";
  $desc = $collectedClasses.FutureCompiler;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FutureCompiler.prototype = $desc;
  function FutureCompiler_generateFutureList_closure(list_0) {
    this.list_0 = list_0;
  }
  FutureCompiler_generateFutureList_closure.builtin$cls = "FutureCompiler_generateFutureList_closure";
  if (!"name" in FutureCompiler_generateFutureList_closure)
    FutureCompiler_generateFutureList_closure.name = "FutureCompiler_generateFutureList_closure";
  $desc = $collectedClasses.FutureCompiler_generateFutureList_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FutureCompiler_generateFutureList_closure.prototype = $desc;
  function FutureCompiler_generateFutureList_closure0(this_1) {
    this.this_1 = this_1;
  }
  FutureCompiler_generateFutureList_closure0.builtin$cls = "FutureCompiler_generateFutureList_closure0";
  if (!"name" in FutureCompiler_generateFutureList_closure0)
    FutureCompiler_generateFutureList_closure0.name = "FutureCompiler_generateFutureList_closure0";
  $desc = $collectedClasses.FutureCompiler_generateFutureList_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FutureCompiler_generateFutureList_closure0.prototype = $desc;
  function Network(networkPorts, _whenAlive, _whenFrozen, _whenDead, sparkflow$Network$_parent, startStamp, stopStamp, graphIterator, scheduledPacketsIterator, scheduledPacketsAlwaysIterator, placeholder, stateManager, connections, uuidRegister, uuid, errorStream, componentStream, networkStream, connectionStream, onReadyConnect, onReadyDisconnect, onAlive, onDead, onFrozen, components, scheduledPackets, scheduledPacketsAlways, connectionsCompiler, disconnectionsCompiler, dfFilter, bfFilter, metas, _parent) {
    this.networkPorts = networkPorts;
    this._whenAlive = _whenAlive;
    this._whenFrozen = _whenFrozen;
    this._whenDead = _whenDead;
    this.sparkflow$Network$_parent = sparkflow$Network$_parent;
    this.startStamp = startStamp;
    this.stopStamp = stopStamp;
    this.graphIterator = graphIterator;
    this.scheduledPacketsIterator = scheduledPacketsIterator;
    this.scheduledPacketsAlwaysIterator = scheduledPacketsAlwaysIterator;
    ...
    this.onReadyConnect = onReadyConnect;
    this.onReadyDisconnect = onReadyDisconnect;
    this.onAlive = onAlive;
    this.onDead = onDead;
    this.onFrozen = onFrozen;
    this.components = components;
    this.scheduledPackets = scheduledPackets;
    this.scheduledPacketsAlways = scheduledPacketsAlways;
    this.connectionsCompiler = connectionsCompiler;
    this.disconnectionsCompiler = disconnectionsCompiler;
  ...
  Network.prototype.get$uuid = function() {
    return this.uuid;
  };
  function closure() {
  }
  ...
  function Network_closure() {
  }
  Network_closure.builtin$cls = "Network_closure";
  if (!"name" in Network_closure)
    Network_closure.name = "Network_closure";
  $desc = $collectedClasses.Network_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_closure.prototype = $desc;
  function Network_closure0() {
  }
  Network_closure0.builtin$cls = "Network_closure0";
  if (!"name" in Network_closure0)
    Network_closure0.name = "Network_closure0";
  $desc = $collectedClasses.Network_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_closure0.prototype = $desc;
  function Network_closure1() {
  }
  Network_closure1.builtin$cls = "Network_closure1";
  if (!"name" in Network_closure1)
    Network_closure1.name = "Network_closure1";
  $desc = $collectedClasses.Network_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_closure1.prototype = $desc;
  function Network_closure2() {
  }
  Network_closure2.builtin$cls = "Network_closure2";
  if (!"name" in Network_closure2)
    Network_closure2.name = "Network_closure2";
  $desc = $collectedClasses.Network_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_closure2.prototype = $desc;
  function Network_closure3() {
  }
  Network_closure3.builtin$cls = "Network_closure3";
  if (!"name" in Network_closure3)
    Network_closure3.name = "Network_closure3";
  $desc = $collectedClasses.Network_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_closure3.prototype = $desc;
  function Network_closure4() {
  }
  Network_closure4.builtin$cls = "Network_closure4";
  if (!"name" in Network_closure4)
    Network_closure4.name = "Network_closure4";
  $desc = $collectedClasses.Network_closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_closure4.prototype = $desc;
  function Network_closure5() {
  }
  Network_closure5.builtin$cls = "Network_closure5";
  if (!"name" in Network_closure5)
    Network_closure5.name = "Network_closure5";
  $desc = $collectedClasses.Network_closure5;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_closure5.prototype = $desc;
  function Network_closure6() {
  }
  Network_closure6.builtin$cls = "Network_closure6";
  if (!"name" in Network_closure6)
    Network_closure6.name = "Network_closure6";
  $desc = $collectedClasses.Network_closure6;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_closure6.prototype = $desc;
  function Network_closure7() {
  }
  Network_closure7.builtin$cls = "Network_closure7";
  if (!"name" in Network_closure7)
    Network_closure7.name = "Network_closure7";
  $desc = $collectedClasses.Network_closure7;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_closure7.prototype = $desc;
  function Network_closure8(this_0) {
    this.this_0 = this_0;
  }
  Network_closure8.builtin$cls = "Network_closure8";
  if (!"name" in Network_closure8)
    Network_closure8.name = "Network_closure8";
  $desc = $collectedClasses.Network_closure8;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_closure8.prototype = $desc;
  function Network_close_closure() {
  }
  Network_close_closure.builtin$cls = "Network_close_closure";
  if (!"name" in Network_close_closure)
    Network_close_closure.name = "Network_close_closure";
  $desc = $collectedClasses.Network_close_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_close_closure.prototype = $desc;
  function Network_close_closure0(this_0) {
    this.this_0 = this_0;
  }
  Network_close_closure0.builtin$cls = "Network_close_closure0";
  if (!"name" in Network_close_closure0)
    Network_close_closure0.name = "Network_close_closure0";
  $desc = $collectedClasses.Network_close_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_close_closure0.prototype = $desc;
  function Network_filterDF_closure() {
  }
  Network_filterDF_closure.builtin$cls = "Network_filterDF_closure";
  if (!"name" in Network_filterDF_closure)
    Network_filterDF_closure.name = "Network_filterDF_closure";
  $desc = $collectedClasses.Network_filterDF_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_filterDF_closure.prototype = $desc;
  function Network_filterDF_closure0(this_0, m_1, id_2) {
    this.this_0 = this_0;
    this.m_1 = m_1;
    this.id_2 = id_2;
  }
  Network_filterDF_closure0.builtin$cls = "Network_filterDF_closure0";
  if (!"name" in Network_filterDF_closure0)
    Network_filterDF_closure0.name = "Network_filterDF_closure0";
  $desc = $collectedClasses.Network_filterDF_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_filterDF_closure0.prototype = $desc;
  function Network__runBootUpScheduledPackets_closure(this_0) {
    this.this_0 = this_0;
  }
  Network__runBootUpScheduledPackets_closure.builtin$cls = "Network__runBootUpScheduledPackets_closure";
  if (!"name" in Network__runBootUpScheduledPackets_closure)
    Network__runBootUpScheduledPackets_closure.name = "Network__runBootUpScheduledPackets_closure";
  $desc = $collectedClasses.Network__runBootUpScheduledPackets_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network__runBootUpScheduledPackets_closure.prototype = $desc;
  function Network__runBootUpScheduledPackets__closure(cur_1) {
    this.cur_1 = cur_1;
  }
  Network__runBootUpScheduledPackets__closure.builtin$cls = "Network__runBootUpScheduledPackets__closure";
  if (!"name" in Network__runBootUpScheduledPackets__closure)
    Network__runBootUpScheduledPackets__closure.name = "Network__runBootUpScheduledPackets__closure";
  $desc = $collectedClasses.Network__runBootUpScheduledPackets__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network__runBootUpScheduledPackets__closure.prototype = $desc;
  function Network__runScheduledPackets_closure(box_0, mixer_1) {
    this.box_0 = box_0;
    this.mixer_1 = mixer_1;
  }
  Network__runScheduledPackets_closure.builtin$cls = "Network__runScheduledPackets_closure";
  if (!"name" in Network__runScheduledPackets_closure)
    Network__runScheduledPackets_closure.name = "Network__runScheduledPackets_closure";
  $desc = $collectedClasses.Network__runScheduledPackets_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network__runScheduledPackets_closure.prototype = $desc;
  function Network__runScheduledPackets_closure0(mixer_2) {
    this.mixer_2 = mixer_2;
  }
  Network__runScheduledPackets_closure0.builtin$cls = "Network__runScheduledPackets_closure0";
  if (!"name" in Network__runScheduledPackets_closure0)
    Network__runScheduledPackets_closure0.name = "Network__runScheduledPackets_closure0";
  $desc = $collectedClasses.Network__runScheduledPackets_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network__runScheduledPackets_closure0.prototype = $desc;
  function Network_destroy_closure() {
  }
  Network_destroy_closure.builtin$cls = "Network_destroy_closure";
  if (!"name" in Network_destroy_closure)
    Network_destroy_closure.name = "Network_destroy_closure";
  $desc = $collectedClasses.Network_destroy_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_destroy_closure.prototype = $desc;
  function Network_remove_closure(this_0, a_1, n_2) {
    this.this_0 = this_0;
    this.a_1 = a_1;
    this.n_2 = n_2;
  }
  Network_remove_closure.builtin$cls = "Network_remove_closure";
  if (!"name" in Network_remove_closure)
    Network_remove_closure.name = "Network_remove_closure";
  $desc = $collectedClasses.Network_remove_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_remove_closure.prototype = $desc;
  function Network_remove_closure0(this_3, a_4) {
    this.this_3 = this_3;
    this.a_4 = a_4;
  }
  Network_remove_closure0.builtin$cls = "Network_remove_closure0";
  if (!"name" in Network_remove_closure0)
    Network_remove_closure0.name = "Network_remove_closure0";
  $desc = $collectedClasses.Network_remove_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_remove_closure0.prototype = $desc;
  function Network_shutdown_closure(this_0, completer_1) {
    this.this_0 = this_0;
    this.completer_1 = completer_1;
  }
  Network_shutdown_closure.builtin$cls = "Network_shutdown_closure";
  if (!"name" in Network_shutdown_closure)
    Network_shutdown_closure.name = "Network_shutdown_closure";
  $desc = $collectedClasses.Network_shutdown_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_shutdown_closure.prototype = $desc;
  function Network_shutdown__closure(this_2) {
    this.this_2 = this_2;
  }
  Network_shutdown__closure.builtin$cls = "Network_shutdown__closure";
  if (!"name" in Network_shutdown__closure)
    Network_shutdown__closure.name = "Network_shutdown__closure";
  $desc = $collectedClasses.Network_shutdown__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_shutdown__closure.prototype = $desc;
  function Network_shutdown__closure0(this_3, completer_4) {
    this.this_3 = this_3;
    this.completer_4 = completer_4;
  }
  Network_shutdown__closure0.builtin$cls = "Network_shutdown__closure0";
  if (!"name" in Network_shutdown__closure0)
    Network_shutdown__closure0.name = "Network_shutdown__closure0";
  $desc = $collectedClasses.Network_shutdown__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_shutdown__closure0.prototype = $desc;
  function Network_shutdown_closure0() {
  }
  Network_shutdown_closure0.builtin$cls = "Network_shutdown_closure0";
  if (!"name" in Network_shutdown_closure0)
    Network_shutdown_closure0.name = "Network_shutdown_closure0";
  $desc = $collectedClasses.Network_shutdown_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_shutdown_closure0.prototype = $desc;
  function Network_boot_closure(this_0, completer_1) {
    this.this_0 = this_0;
    this.completer_1 = completer_1;
  }
  Network_boot_closure.builtin$cls = "Network_boot_closure";
  if (!"name" in Network_boot_closure)
    Network_boot_closure.name = "Network_boot_closure";
  $desc = $collectedClasses.Network_boot_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_boot_closure.prototype = $desc;
  function Network_boot__closure(this_2) {
    this.this_2 = this_2;
  }
  Network_boot__closure.builtin$cls = "Network_boot__closure";
  if (!"name" in Network_boot__closure)
    Network_boot__closure.name = "Network_boot__closure";
  $desc = $collectedClasses.Network_boot__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_boot__closure.prototype = $desc;
  function Network_boot__closure0(this_3, completer_4) {
    this.this_3 = this_3;
    this.completer_4 = completer_4;
  }
  Network_boot__closure0.builtin$cls = "Network_boot__closure0";
  if (!"name" in Network_boot__closure0)
    Network_boot__closure0.name = "Network_boot__closure0";
  $desc = $collectedClasses.Network_boot__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_boot__closure0.prototype = $desc;
  function Network_boot_closure0() {
  }
  Network_boot_closure0.builtin$cls = "Network_boot_closure0";
  if (!"name" in Network_boot_closure0)
    Network_boot_closure0.name = "Network_boot_closure0";
  $desc = $collectedClasses.Network_boot_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_boot_closure0.prototype = $desc;
  function Network_ensureBinding_closure(this_0, from_1, fp_2, to_3, tp_4, sid_5, ve_6, f_7) {
    this.this_0 = this_0;
    this.from_1 = from_1;
    this.fp_2 = fp_2;
    this.to_3 = to_3;
  ...
  Network_ensureBinding_closure.builtin$cls = "Network_ensureBinding_closure";
  if (!"name" in Network_ensureBinding_closure)
    Network_ensureBinding_closure.name = "Network_ensureBinding_closure";
  $desc = $collectedClasses.Network_ensureBinding_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_ensureBinding_closure.prototype = $desc;
  function Network_link_closure(box_0, this_1, nport_2, com_3, inport_4, sid_5, ve_6, bf_7) {
    this.box_0 = box_0;
    this.this_1 = this_1;
    this.nport_2 = nport_2;
    this.com_3 = com_3;
    this.inport_4 = inport_4;
    this.sid_5 = sid_5;
    this.ve_6 = ve_6;
    this.bf_7 = bf_7;
  }
  Network_link_closure.builtin$cls = "Network_link_closure";
  if (!"name" in Network_link_closure)
    Network_link_closure.name = "Network_link_closure";
  $desc = $collectedClasses.Network_link_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_link_closure.prototype = $desc;
  function Network_link__closure(box_0, this_8, nport_9, com_10, inport_11, sid_12, ve_13) {
    this.box_0 = box_0;
    this.this_8 = this_8;
    this.nport_9 = nport_9;
    this.com_10 = com_10;
    this.inport_11 = inport_11;
    this.sid_12 = sid_12;
    this.ve_13 = ve_13;
  }
  Network_link__closure.builtin$cls = "Network_link__closure";
  if (!"name" in Network_link__closure)
    Network_link__closure.name = "Network_link__closure";
  $desc = $collectedClasses.Network_link__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_link__closure.prototype = $desc;
  function Network_doBinding_closure(this_0, from_1, fp_2, to_3, tp_4, sid_5, ve_6) {
    this.this_0 = this_0;
    this.from_1 = from_1;
    this.fp_2 = fp_2;
    this.to_3 = to_3;
  ...
  Network_doBinding_closure.builtin$cls = "Network_doBinding_closure";
  if (!"name" in Network_doBinding_closure)
    Network_doBinding_closure.name = "Network_doBinding_closure";
  $desc = $collectedClasses.Network_doBinding_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_doBinding_closure.prototype = $desc;
  function Network_doBinding__closure(this_7, from_8, fp_9, to_10, tp_11, sid_12, ve_13) {
    this.this_7 = this_7;
    this.from_8 = from_8;
    this.fp_9 = fp_9;
    this.to_10 = to_10;
  ...
  Network_doBinding__closure.builtin$cls = "Network_doBinding__closure";
  if (!"name" in Network_doBinding__closure)
    Network_doBinding__closure.name = "Network_doBinding__closure";
  $desc = $collectedClasses.Network_doBinding__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_doBinding__closure.prototype = $desc;
  function Network_doBinding__closure0(this_14, from_15, fp_16, to_17, tp_18, sid_19) {
    this.this_14 = this_14;
    this.from_15 = from_15;
    this.fp_16 = fp_16;
    this.to_17 = to_17;
    this.tp_18 = tp_18;
    this.sid_19 = sid_19;
  }
  Network_doBinding__closure0.builtin$cls = "Network_doBinding__closure0";
  if (!"name" in Network_doBinding__closure0)
    Network_doBinding__closure0.name = "Network_doBinding__closure0";
  $desc = $collectedClasses.Network_doBinding__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_doBinding__closure0.prototype = $desc;
  function Network_doBinding_closure0(this_20, fp_21, tp_22, sid_23, ve_24) {
  ...
  Network_doBinding_closure0.builtin$cls = "Network_doBinding_closure0";
  if (!"name" in Network_doBinding_closure0)
    Network_doBinding_closure0.name = "Network_doBinding_closure0";
  $desc = $collectedClasses.Network_doBinding_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_doBinding_closure0.prototype = $desc;
  function Network_doBinding_closure1(this_25, from_26, fp_27, to_28, tp_29, sid_30, ve_31, f_32) {
    this.this_25 = this_25;
    this.from_26 = from_26;
    this.fp_27 = fp_27;
    this.to_28 = to_28;
    this.tp_29 = tp_29;
    this.sid_30 = sid_30;
  ...
  Network_doBinding_closure1.builtin$cls = "Network_doBinding_closure1";
  if (!"name" in Network_doBinding_closure1)
    Network_doBinding_closure1.name = "Network_doBinding_closure1";
  $desc = $collectedClasses.Network_doBinding_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_doBinding_closure1.prototype = $desc;
  function Network_doBinding_closure2(this_33, fp_34, to_35, tp_36, sid_37, ve_38, f_39) {
  ...
  Network_doBinding_closure2.builtin$cls = "Network_doBinding_closure2";
  if (!"name" in Network_doBinding_closure2)
    Network_doBinding_closure2.name = "Network_doBinding_closure2";
  $desc = $collectedClasses.Network_doBinding_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_doBinding_closure2.prototype = $desc;
  function Network_doBinding_closure3(this_40, from_41, fp_42, tp_43, sid_44, ve_45, f_46) {
    this.this_40 = this_40;
    this.from_41 = from_41;
    this.fp_42 = fp_42;
    this.tp_43 = tp_43;
    this.sid_44 = sid_44;
    this.ve_45 = ve_45;
  ...
  Network_doBinding_closure3.builtin$cls = "Network_doBinding_closure3";
  if (!"name" in Network_doBinding_closure3)
    Network_doBinding_closure3.name = "Network_doBinding_closure3";
  $desc = $collectedClasses.Network_doBinding_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_doBinding_closure3.prototype = $desc;
  function Network_connect_closure(this_0, a_1, aport_2, b_3, bport_4, sockid_5, ve_6, bf_7) {
    this.this_0 = this_0;
    this.a_1 = a_1;
    this.aport_2 = aport_2;
    this.b_3 = b_3;
    this.bport_4 = bport_4;
    this.sockid_5 = sockid_5;
    this.ve_6 = ve_6;
    this.bf_7 = bf_7;
  }
  Network_connect_closure.builtin$cls = "Network_connect_closure";
  if (!"name" in Network_connect_closure)
    Network_connect_closure.name = "Network_connect_closure";
  $desc = $collectedClasses.Network_connect_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_connect_closure.prototype = $desc;
  function Network_connect__closure(this_8, a_9, aport_10, b_11, bport_12, sockid_13, ve_14) {
    this.this_8 = this_8;
    this.a_9 = a_9;
    this.aport_10 = aport_10;
    this.b_11 = b_11;
    this.bport_12 = bport_12;
    this.sockid_13 = sockid_13;
    this.ve_14 = ve_14;
  }
  Network_connect__closure.builtin$cls = "Network_connect__closure";
  if (!"name" in Network_connect__closure)
    Network_connect__closure.name = "Network_connect__closure";
  $desc = $collectedClasses.Network_connect__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_connect__closure.prototype = $desc;
  function Network_connect__closure0(this_15, a_16, aport_17, b_18, bport_19, sockid_20) {
    this.this_15 = this_15;
    this.a_16 = a_16;
    this.aport_17 = aport_17;
    this.b_18 = b_18;
    this.bport_19 = bport_19;
    this.sockid_20 = sockid_20;
  }
  Network_connect__closure0.builtin$cls = "Network_connect__closure0";
  if (!"name" in Network_connect__closure0)
    Network_connect__closure0.name = "Network_connect__closure0";
  $desc = $collectedClasses.Network_connect__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_connect__closure0.prototype = $desc;
  function Network_loopPorts_closure(this_0, p_1, s_2, sid_3, ve_4) {
    this.this_0 = this_0;
    this.p_1 = p_1;
    this.s_2 = s_2;
    this.sid_3 = sid_3;
  ...
  Network_loopPorts_closure.builtin$cls = "Network_loopPorts_closure";
  if (!"name" in Network_loopPorts_closure)
    Network_loopPorts_closure.name = "Network_loopPorts_closure";
  $desc = $collectedClasses.Network_loopPorts_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network_loopPorts_closure.prototype = $desc;
  function ConnectionMeta(handler, storage) {
    this.handler = handler;
    this.storage = storage;
  }
  ConnectionMeta.builtin$cls = "ConnectionMeta";
  if (!"name" in ConnectionMeta)
    ConnectionMeta.name = "ConnectionMeta";
  $desc = $collectedClasses.ConnectionMeta;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ConnectionMeta.prototype = $desc;
  function ConnectionMeta_filterUUIDPort_closure(port_0, sockid_1) {
    this.port_0 = port_0;
    this.sockid_1 = sockid_1;
  }
  ConnectionMeta_filterUUIDPort_closure.builtin$cls = "ConnectionMeta_filterUUIDPort_closure";
  if (!"name" in ConnectionMeta_filterUUIDPort_closure)
    ConnectionMeta_filterUUIDPort_closure.name = "ConnectionMeta_filterUUIDPort_closure";
  $desc = $collectedClasses.ConnectionMeta_filterUUIDPort_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ConnectionMeta_filterUUIDPort_closure.prototype = $desc;
  function ConnectionMeta_addConnection_closure(port_0, sockid_1, uuidp_2) {
    this.port_0 = port_0;
    this.sockid_1 = sockid_1;
    this.uuidp_2 = uuidp_2;
  }
  ConnectionMeta_addConnection_closure.builtin$cls = "ConnectionMeta_addConnection_closure";
  if (!"name" in ConnectionMeta_addConnection_closure)
    ConnectionMeta_addConnection_closure.name = "ConnectionMeta_addConnection_closure";
  $desc = $collectedClasses.ConnectionMeta_addConnection_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ConnectionMeta_addConnection_closure.prototype = $desc;
  function ConnectionMeta_removeConnection_closure(uuid_0, core_1, item_2, uuidp_3) {
    this.uuid_0 = uuid_0;
    this.core_1 = core_1;
    this.item_2 = item_2;
    this.uuidp_3 = uuidp_3;
  }
  ConnectionMeta_removeConnection_closure.builtin$cls = "ConnectionMeta_removeConnection_closure";
  if (!"name" in ConnectionMeta_removeConnection_closure)
    ConnectionMeta_removeConnection_closure.name = "ConnectionMeta_removeConnection_closure";
  $desc = $collectedClasses.ConnectionMeta_removeConnection_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ConnectionMeta_removeConnection_closure.prototype = $desc;
  function ConnectionMeta_removeConnection__closure(uuidp_4) {
    this.uuidp_4 = uuidp_4;
  }
  ConnectionMeta_removeConnection__closure.builtin$cls = "ConnectionMeta_removeConnection__closure";
  if (!"name" in ConnectionMeta_removeConnection__closure)
    ConnectionMeta_removeConnection__closure.name = "ConnectionMeta_removeConnection__closure";
  $desc = $collectedClasses.ConnectionMeta_removeConnection__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ConnectionMeta_removeConnection__closure.prototype = $desc;
  function PortGroup(defaults, events, portLists, owner, groupClass) {
  ...
  PortGroup.builtin$cls = "PortGroup";
  if (!"name" in PortGroup)
    PortGroup.name = "PortGroup";
  $desc = $collectedClasses.PortGroup;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PortGroup.prototype = $desc;
  PortGroup.prototype.get$owner = function() {
    return this.owner;
  };
  function PortGroup_addInport_closure() {
  }
  PortGroup_addInport_closure.builtin$cls = "PortGroup_addInport_closure";
  if (!"name" in PortGroup_addInport_closure)
    PortGroup_addInport_closure.name = "PortGroup_addInport_closure";
  $desc = $collectedClasses.PortGroup_addInport_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PortGroup_addInport_closure.prototype = $desc;
  function PortGroup_addOutPort_closure() {
  }
  PortGroup_addOutPort_closure.builtin$cls = "PortGroup_addOutPort_closure";
  if (!"name" in PortGroup_addOutPort_closure)
    PortGroup_addOutPort_closure.name = "PortGroup_addOutPort_closure";
  $desc = $collectedClasses.PortGroup_addOutPort_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PortGroup_addOutPort_closure.prototype = $desc;
  function PortGroup_close_closure() {
  }
  PortGroup_close_closure.builtin$cls = "PortGroup_close_closure";
  if (!"name" in PortGroup_close_closure)
    PortGroup_close_closure.name = "PortGroup_close_closure";
  $desc = $collectedClasses.PortGroup_close_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PortGroup_close_closure.prototype = $desc;
  function PortGroup_pauseAll_closure(this_0) {
    this.this_0 = this_0;
  }
  PortGroup_pauseAll_closure.builtin$cls = "PortGroup_pauseAll_closure";
  if (!"name" in PortGroup_pauseAll_closure)
    PortGroup_pauseAll_closure.name = "PortGroup_pauseAll_closure";
  $desc = $collectedClasses.PortGroup_pauseAll_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PortGroup_pauseAll_closure.prototype = $desc;
  function PortGroup_flushAll_closure(this_0) {
    this.this_0 = this_0;
  }
  PortGroup_flushAll_closure.builtin$cls = "PortGroup_flushAll_closure";
  if (!"name" in PortGroup_flushAll_closure)
    PortGroup_flushAll_closure.name = "PortGroup_flushAll_closure";
  $desc = $collectedClasses.PortGroup_flushAll_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PortGroup_flushAll_closure.prototype = $desc;
  function PortManager(portsGroup, owner) {
    this.portsGroup = portsGroup;
    this.owner = owner;
  }
  PortManager.builtin$cls = "PortManager";
  if (!"name" in PortManager)
    PortManager.name = "PortManager";
  $desc = $collectedClasses.PortManager;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PortManager.prototype = $desc;
  PortManager.prototype.get$owner = function() {
    return this.owner;
  };
  function PortManager_destroyAllSpaces_closure(n_0) {
    this.n_0 = n_0;
  }
  PortManager_destroyAllSpaces_closure.builtin$cls = "PortManager_destroyAllSpaces_closure";
  if (!"name" in PortManager_destroyAllSpaces_closure)
    PortManager_destroyAllSpaces_closure.name = "PortManager_destroyAllSpaces_closure";
  $desc = $collectedClasses.PortManager_destroyAllSpaces_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PortManager_destroyAllSpaces_closure.prototype = $desc;
  function PortManager_flushAllPackets_closure() {
  }
  PortManager_flushAllPackets_closure.builtin$cls = "PortManager_flushAllPackets_closure";
  if (!"name" in PortManager_flushAllPackets_closure)
    PortManager_flushAllPackets_closure.name = "PortManager_flushAllPackets_closure";
  $desc = $collectedClasses.PortManager_flushAllPackets_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PortManager_flushAllPackets_closure.prototype = $desc;
  function PortManager_pauseAll_closure() {
  }
  PortManager_pauseAll_closure.builtin$cls = "PortManager_pauseAll_closure";
  if (!"name" in PortManager_pauseAll_closure)
    PortManager_pauseAll_closure.name = "PortManager_pauseAll_closure";
  $desc = $collectedClasses.PortManager_pauseAll_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PortManager_pauseAll_closure.prototype = $desc;
  function Component(connectionStream, stateStream, bootups, freezups, shutdowns, sharedState, _connections, network, comPorts, uuid, metas, bindMeta, assocMeta, sharedData, _mutator) {
    this.connectionStream = connectionStream;
    this.stateStream = stateStream;
    this.bootups = bootups;
    this.freezups = freezups;
    ...
    this.uuid = uuid;
    this.metas = metas;
    this.bindMeta = bindMeta;
    this.assocMeta = assocMeta;
  ...
  function Component_closure() {
  }
  Component_closure.builtin$cls = "Component_closure";
  if (!"name" in Component_closure)
    Component_closure.name = "Component_closure";
  $desc = $collectedClasses.Component_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Component_closure.prototype = $desc;
  function Component_closure0() {
  }
  Component_closure0.builtin$cls = "Component_closure0";
  if (!"name" in Component_closure0)
    Component_closure0.name = "Component_closure0";
  $desc = $collectedClasses.Component_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Component_closure0.prototype = $desc;
  function Component_closure1() {
  }
  Component_closure1.builtin$cls = "Component_closure1";
  if (!"name" in Component_closure1)
    Component_closure1.name = "Component_closure1";
  $desc = $collectedClasses.Component_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Component_closure1.prototype = $desc;
  function Component_closure2() {
  }
  Component_closure2.builtin$cls = "Component_closure2";
  if (!"name" in Component_closure2)
    Component_closure2.name = "Component_closure2";
  $desc = $collectedClasses.Component_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Component_closure2.prototype = $desc;
  function Component_closure3() {
  }
  Component_closure3.builtin$cls = "Component_closure3";
  if (!"name" in Component_closure3)
    Component_closure3.name = "Component_closure3";
  $desc = $collectedClasses.Component_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Component_closure3.prototype = $desc;
  function Component_closure4() {
  }
  Component_closure4.builtin$cls = "Component_closure4";
  if (!"name" in Component_closure4)
    Component_closure4.name = "Component_closure4";
  $desc = $collectedClasses.Component_closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Component_closure4.prototype = $desc;
  function Component_closure5() {
  }
  Component_closure5.builtin$cls = "Component_closure5";
  if (!"name" in Component_closure5)
    Component_closure5.name = "Component_closure5";
  $desc = $collectedClasses.Component_closure5;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Component_closure5.prototype = $desc;
  function Component_closure6() {
  }
  Component_closure6.builtin$cls = "Component_closure6";
  if (!"name" in Component_closure6)
    Component_closure6.name = "Component_closure6";
  $desc = $collectedClasses.Component_closure6;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Component_closure6.prototype = $desc;
  function Component_closure7() {
  }
  Component_closure7.builtin$cls = "Component_closure7";
  if (!"name" in Component_closure7)
    Component_closure7.name = "Component_closure7";
  $desc = $collectedClasses.Component_closure7;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Component_closure7.prototype = $desc;
  function Component_closure8(this_0) {
    this.this_0 = this_0;
  }
  Component_closure8.builtin$cls = "Component_closure8";
  if (!"name" in Component_closure8)
    Component_closure8.name = "Component_closure8";
  $desc = $collectedClasses.Component_closure8;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Component_closure8.prototype = $desc;
  function Component__closure(this_1, e_2) {
    this.this_1 = this_1;
    this.e_2 = e_2;
  }
  Component__closure.builtin$cls = "Component__closure";
  if (!"name" in Component__closure)
    Component__closure.name = "Component__closure";
  $desc = $collectedClasses.Component__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Component__closure.prototype = $desc;
  function Component__closure0(this_3, e_4) {
    this.this_3 = this_3;
    this.e_4 = e_4;
  }
  Component__closure0.builtin$cls = "Component__closure0";
  if (!"name" in Component__closure0)
    Component__closure0.name = "Component__closure0";
  $desc = $collectedClasses.Component__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Component__closure0.prototype = $desc;
  function Component_boot_closure(this_0) {
    this.this_0 = this_0;
  }
  Component_boot_closure.builtin$cls = "Component_boot_closure";
  if (!"name" in Component_boot_closure)
    Component_boot_closure.name = "Component_boot_closure";
  $desc = $collectedClasses.Component_boot_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Component_boot_closure.prototype = $desc;
  function Component_shutdown_closure(this_0) {
    this.this_0 = this_0;
  }
  Component_shutdown_closure.builtin$cls = "Component_shutdown_closure";
  if (!"name" in Component_shutdown_closure)
    Component_shutdown_closure.name = "Component_shutdown_closure";
  $desc = $collectedClasses.Component_shutdown_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Component_shutdown_closure.prototype = $desc;
  function Component_close_closure() {
  }
  Component_close_closure.builtin$cls = "Component_close_closure";
  if (!"name" in Component_close_closure)
    Component_close_closure.name = "Component_close_closure";
  $desc = $collectedClasses.Component_close_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Component_close_closure.prototype = $desc;
  function MassTree(canDestroy, storage) {
    this.canDestroy = canDestroy;
    this.storage = storage;
  }
  MassTree.builtin$cls = "MassTree";
  if (!"name" in MassTree)
    MassTree.name = "MassTree";
  $desc = $collectedClasses.MassTree;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MassTree.prototype = $desc;
  function ComponentGroup(groups, uuid, id) {
    this.groups = groups;
    this.uuid = uuid;
    this.id = id;
  }
  ComponentGroup.builtin$cls = "ComponentGroup";
  if (!"name" in ComponentGroup)
    ComponentGroup.name = "ComponentGroup";
  $desc = $collectedClasses.ComponentGroup;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ComponentGroup.prototype = $desc;
  ComponentGroup.prototype.get$uuid = function() {
    return this.uuid;
  };
  ComponentGroup.prototype.get$id = function(receiver) {
    return this.id;
  };
  function ComponentGroup_add_closure(generator_0, path_1) {
    this.generator_0 = generator_0;
    this.path_1 = path_1;
  }
  ComponentGroup_add_closure.builtin$cls = "ComponentGroup_add_closure";
  if (!"name" in ComponentGroup_add_closure)
    ComponentGroup_add_closure.name = "ComponentGroup_add_closure";
  $desc = $collectedClasses.ComponentGroup_add_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ComponentGroup_add_closure.prototype = $desc;
  function SparkGroups(groupSets) {
    this.groupSets = groupSets;
  }
  SparkGroups.builtin$cls = "SparkGroups";
  if (!"name" in SparkGroups)
    SparkGroups.name = "SparkGroups";
  $desc = $collectedClasses.SparkGroups;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SparkGroups.prototype = $desc;
  function Streamer() {
  }
  Streamer.builtin$cls = "Streamer";
  if (!"name" in Streamer)
    Streamer.name = "Streamer";
  $desc = $collectedClasses.Streamer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamer.prototype = $desc;
  function Listener() {
  }
  Listener.builtin$cls = "Listener";
  if (!"name" in Listener)
    Listener.name = "Listener";
  $desc = $collectedClasses.Listener;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Listener.prototype = $desc;
  function Distributor(listeners, done, onced, id, listenerIterator, doneIterator, onceIterator, _locked) {
    this.listeners = listeners;
    this.done = done;
    this.onced = onced;
    this.id = id;
    this.listenerIterator = listenerIterator;
    this.doneIterator = doneIterator;
    this.onceIterator = onceIterator;
  ...
  Distributor.prototype.get$id = function(receiver) {
    return this.id;
  };
  function Streamable(streams, transformer, initd, drained, ended, closed, resumer, pauser, listeners, listenersAdded, listenersRemoved, state, pushState, flush, iterator, _willEndOnDrain, _ender, _endStreamDispatcher) {
    this.streams = streams;
    ...
    this._willEndOnDrain = _willEndOnDrain;
    this._ender = _ender;
    this._endStreamDispatcher = _endStreamDispatcher;
  }
  Streamable.builtin$cls = "Streamable";
  if (!"name" in Streamable)
    Streamable.name = "Streamable";
  $desc = $collectedClasses.Streamable;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable.prototype = $desc;
  Streamable.prototype.get$iterator = function(receiver) {
    return this.iterator;
  };
  function Streamable_closure(this_0) {
    this.this_0 = this_0;
  }
  Streamable_closure.builtin$cls = "Streamable_closure";
  if (!"name" in Streamable_closure)
    Streamable_closure.name = "Streamable_closure";
  $desc = $collectedClasses.Streamable_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure.prototype = $desc;
  function Streamable_closure0() {
  }
  Streamable_closure0.builtin$cls = "Streamable_closure0";
  if (!"name" in Streamable_closure0)
    Streamable_closure0.name = "Streamable_closure0";
  $desc = $collectedClasses.Streamable_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure0.prototype = $desc;
  function Streamable_closure1() {
  }
  Streamable_closure1.builtin$cls = "Streamable_closure1";
  if (!"name" in Streamable_closure1)
    Streamable_closure1.name = "Streamable_closure1";
  $desc = $collectedClasses.Streamable_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure1.prototype = $desc;
  function Streamable_closure2() {
  }
  Streamable_closure2.builtin$cls = "Streamable_closure2";
  if (!"name" in Streamable_closure2)
    Streamable_closure2.name = "Streamable_closure2";
  $desc = $collectedClasses.Streamable_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure2.prototype = $desc;
  function Streamable_closure3() {
  }
  Streamable_closure3.builtin$cls = "Streamable_closure3";
  if (!"name" in Streamable_closure3)
    Streamable_closure3.name = "Streamable_closure3";
  $desc = $collectedClasses.Streamable_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure3.prototype = $desc;
  function Streamable_closure4() {
  }
  Streamable_closure4.builtin$cls = "Streamable_closure4";
  if (!"name" in Streamable_closure4)
    Streamable_closure4.name = "Streamable_closure4";
  $desc = $collectedClasses.Streamable_closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure4.prototype = $desc;
  function Streamable_closure5() {
  }
  Streamable_closure5.builtin$cls = "Streamable_closure5";
  if (!"name" in Streamable_closure5)
    Streamable_closure5.name = "Streamable_closure5";
  $desc = $collectedClasses.Streamable_closure5;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure5.prototype = $desc;
  function Streamable_closure6() {
  }
  Streamable_closure6.builtin$cls = "Streamable_closure6";
  if (!"name" in Streamable_closure6)
    Streamable_closure6.name = "Streamable_closure6";
  $desc = $collectedClasses.Streamable_closure6;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure6.prototype = $desc;
  function Streamable_closure7() {
  }
  Streamable_closure7.builtin$cls = "Streamable_closure7";
  if (!"name" in Streamable_closure7)
    Streamable_closure7.name = "Streamable_closure7";
  $desc = $collectedClasses.Streamable_closure7;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure7.prototype = $desc;
  function Streamable_closure8() {
  }
  Streamable_closure8.builtin$cls = "Streamable_closure8";
  if (!"name" in Streamable_closure8)
    Streamable_closure8.name = "Streamable_closure8";
  $desc = $collectedClasses.Streamable_closure8;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure8.prototype = $desc;
  function Streamable_closure9() {
  }
  Streamable_closure9.builtin$cls = "Streamable_closure9";
  if (!"name" in Streamable_closure9)
    Streamable_closure9.name = "Streamable_closure9";
  $desc = $collectedClasses.Streamable_closure9;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure9.prototype = $desc;
  function Streamable_closure10() {
  }
  Streamable_closure10.builtin$cls = "Streamable_closure10";
  if (!"name" in Streamable_closure10)
    Streamable_closure10.name = "Streamable_closure10";
  $desc = $collectedClasses.Streamable_closure10;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure10.prototype = $desc;
  function Streamable_closure11() {
  }
  Streamable_closure11.builtin$cls = "Streamable_closure11";
  if (!"name" in Streamable_closure11)
    Streamable_closure11.name = "Streamable_closure11";
  $desc = $collectedClasses.Streamable_closure11;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure11.prototype = $desc;
  function Streamable_closure12() {
  }
  Streamable_closure12.builtin$cls = "Streamable_closure12";
  if (!"name" in Streamable_closure12)
    Streamable_closure12.name = "Streamable_closure12";
  $desc = $collectedClasses.Streamable_closure12;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure12.prototype = $desc;
  function Streamable_closure13() {
  }
  Streamable_closure13.builtin$cls = "Streamable_closure13";
  if (!"name" in Streamable_closure13)
    Streamable_closure13.name = "Streamable_closure13";
  $desc = $collectedClasses.Streamable_closure13;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure13.prototype = $desc;
  function Streamable_closure14() {
  }
  Streamable_closure14.builtin$cls = "Streamable_closure14";
  if (!"name" in Streamable_closure14)
    Streamable_closure14.name = "Streamable_closure14";
  $desc = $collectedClasses.Streamable_closure14;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure14.prototype = $desc;
  function Streamable_closure15() {
  }
  Streamable_closure15.builtin$cls = "Streamable_closure15";
  if (!"name" in Streamable_closure15)
    Streamable_closure15.name = "Streamable_closure15";
  $desc = $collectedClasses.Streamable_closure15;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure15.prototype = $desc;
  function Streamable_closure16() {
  }
  Streamable_closure16.builtin$cls = "Streamable_closure16";
  if (!"name" in Streamable_closure16)
    Streamable_closure16.name = "Streamable_closure16";
  $desc = $collectedClasses.Streamable_closure16;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure16.prototype = $desc;
  function Streamable_closure17() {
  }
  Streamable_closure17.builtin$cls = "Streamable_closure17";
  if (!"name" in Streamable_closure17)
    Streamable_closure17.name = "Streamable_closure17";
  $desc = $collectedClasses.Streamable_closure17;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure17.prototype = $desc;
  function Streamable_closure18() {
  }
  Streamable_closure18.builtin$cls = "Streamable_closure18";
  if (!"name" in Streamable_closure18)
    Streamable_closure18.name = "Streamable_closure18";
  $desc = $collectedClasses.Streamable_closure18;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure18.prototype = $desc;
  function Streamable_closure19() {
  }
  Streamable_closure19.builtin$cls = "Streamable_closure19";
  if (!"name" in Streamable_closure19)
    Streamable_closure19.name = "Streamable_closure19";
  $desc = $collectedClasses.Streamable_closure19;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure19.prototype = $desc;
  function Streamable_closure20() {
  }
  Streamable_closure20.builtin$cls = "Streamable_closure20";
  if (!"name" in Streamable_closure20)
    Streamable_closure20.name = "Streamable_closure20";
  $desc = $collectedClasses.Streamable_closure20;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure20.prototype = $desc;
  function Streamable_closure21() {
  }
  Streamable_closure21.builtin$cls = "Streamable_closure21";
  if (!"name" in Streamable_closure21)
    Streamable_closure21.name = "Streamable_closure21";
  $desc = $collectedClasses.Streamable_closure21;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure21.prototype = $desc;
  function Streamable_closure22() {
  }
  Streamable_closure22.builtin$cls = "Streamable_closure22";
  if (!"name" in Streamable_closure22)
    Streamable_closure22.name = "Streamable_closure22";
  $desc = $collectedClasses.Streamable_closure22;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure22.prototype = $desc;
  function Streamable_closure23() {
  }
  Streamable_closure23.builtin$cls = "Streamable_closure23";
  if (!"name" in Streamable_closure23)
    Streamable_closure23.name = "Streamable_closure23";
  $desc = $collectedClasses.Streamable_closure23;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure23.prototype = $desc;
  function Streamable_closure24() {
  }
  Streamable_closure24.builtin$cls = "Streamable_closure24";
  if (!"name" in Streamable_closure24)
    Streamable_closure24.name = "Streamable_closure24";
  $desc = $collectedClasses.Streamable_closure24;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure24.prototype = $desc;
  function Streamable_closure25() {
  }
  Streamable_closure25.builtin$cls = "Streamable_closure25";
  if (!"name" in Streamable_closure25)
    Streamable_closure25.name = "Streamable_closure25";
  $desc = $collectedClasses.Streamable_closure25;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure25.prototype = $desc;
  function Streamable_closure26() {
  }
  Streamable_closure26.builtin$cls = "Streamable_closure26";
  if (!"name" in Streamable_closure26)
    Streamable_closure26.name = "Streamable_closure26";
  $desc = $collectedClasses.Streamable_closure26;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure26.prototype = $desc;
  function Streamable_closure27() {
  }
  Streamable_closure27.builtin$cls = "Streamable_closure27";
  if (!"name" in Streamable_closure27)
    Streamable_closure27.name = "Streamable_closure27";
  $desc = $collectedClasses.Streamable_closure27;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure27.prototype = $desc;
  function Streamable_closure28() {
  }
  Streamable_closure28.builtin$cls = "Streamable_closure28";
  if (!"name" in Streamable_closure28)
    Streamable_closure28.name = "Streamable_closure28";
  $desc = $collectedClasses.Streamable_closure28;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure28.prototype = $desc;
  function Streamable_closure29() {
  }
  Streamable_closure29.builtin$cls = "Streamable_closure29";
  if (!"name" in Streamable_closure29)
    Streamable_closure29.name = "Streamable_closure29";
  $desc = $collectedClasses.Streamable_closure29;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure29.prototype = $desc;
  function Streamable_closure30() {
  }
  Streamable_closure30.builtin$cls = "Streamable_closure30";
  if (!"name" in Streamable_closure30)
    Streamable_closure30.name = "Streamable_closure30";
  $desc = $collectedClasses.Streamable_closure30;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure30.prototype = $desc;
  function Streamable_closure31(this_1) {
    this.this_1 = this_1;
  }
  Streamable_closure31.builtin$cls = "Streamable_closure31";
  if (!"name" in Streamable_closure31)
    Streamable_closure31.name = "Streamable_closure31";
  $desc = $collectedClasses.Streamable_closure31;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure31.prototype = $desc;
  function Streamable_closure32(this_2) {
    this.this_2 = this_2;
  }
  Streamable_closure32.builtin$cls = "Streamable_closure32";
  if (!"name" in Streamable_closure32)
    Streamable_closure32.name = "Streamable_closure32";
  $desc = $collectedClasses.Streamable_closure32;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Streamable_closure32.prototype = $desc;
  function Subscriber(stream, source, _endHandler, info) {
    this.stream = stream;
    this.source = source;
    this._endHandler = _endHandler;
    this.info = info;
  }
  Subscriber.builtin$cls = "Subscriber";
  if (!"name" in Subscriber)
    Subscriber.name = "Subscriber";
  $desc = $collectedClasses.Subscriber;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Subscriber.prototype = $desc;
  function Subscriber_closure(this_0) {
    this.this_0 = this_0;
  }
  Subscriber_closure.builtin$cls = "Subscriber_closure";
  if (!"name" in Subscriber_closure)
    Subscriber_closure.name = "Subscriber_closure";
  $desc = $collectedClasses.Subscriber_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Subscriber_closure.prototype = $desc;
  function Subscriber_closure0(this_1) {
    this.this_1 = this_1;
  }
  Subscriber_closure0.builtin$cls = "Subscriber_closure0";
  if (!"name" in Subscriber_closure0)
    Subscriber_closure0.name = "Subscriber_closure0";
  $desc = $collectedClasses.Subscriber_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Subscriber_closure0.prototype = $desc;
  function Subscriber_closure1(this_2) {
    this.this_2 = this_2;
  }
  Subscriber_closure1.builtin$cls = "Subscriber_closure1";
  if (!"name" in Subscriber_closure1)
    Subscriber_closure1.name = "Subscriber_closure1";
  $desc = $collectedClasses.Subscriber_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Subscriber_closure1.prototype = $desc;
  return [HtmlElement, AnchorElement, AnimationEvent, AreaElement, AudioElement, AutocompleteErrorEvent, BRElement, BaseElement, BeforeLoadEvent, BeforeUnloadEvent, Blob, BodyElement, ButtonElement, CDataSection, CanvasElement, CanvasGradient, CanvasPattern, CanvasRenderingContext, CanvasRenderingContext2D, CharacterData, CloseEvent, Comment, CompositionEvent, ContentElement, CssFontFaceLoadEvent, CustomEvent, DListElement, DataListElement, DetailsElement, DeviceMotionEvent, DeviceOrientationEvent, DialogElement, DivElement, Document, DocumentFragment, DomError, DomException, Element, EmbedElement, ErrorEvent, Event, EventTarget, FieldSetElement, File, FileError, FocusEvent, FormElement, HRElement, HashChangeEvent, HeadElement, HeadingElement, HtmlDocument, HtmlHtmlElement, IFrameElement, ImageElement, InputElement, InstallEvent, InstallPhaseEvent, KeyboardEvent, KeygenElement, LIElement, LabelElement, LegendElement, LinkElement, MapElement, MediaElement, MediaError, MediaKeyError, MediaKeyEvent, MediaKeyMessageEvent, MediaKeyNeededEvent, MediaStream, MediaStreamEvent, MediaStreamTrackEvent, MenuElement, MessageEvent, MetaElement, MeterElement, MidiConnectionEvent, MidiInput, MidiMessageEvent, MidiOutput, MidiPort, ModElement, MouseEvent, Navigator, NavigatorUserMediaError, Node, NodeList, OListElement, ObjectElement, OptGroupElement, OptionElement, OutputElement, OverflowEvent, PageTransitionEvent, ParagraphElement, ParamElement, PopStateEvent, PositionError, PreElement, ProcessingInstruction, ProgressElement, ProgressEvent, QuoteElement, ResourceProgressEvent, RtcDataChannelEvent, RtcDtmfToneChangeEvent, RtcIceCandidateEvent, ScriptElement, SecurityPolicyViolationEvent, SelectElement, ShadowElement, ShadowRoot, SourceElement, SpanElement, SpeechInputEvent, SpeechRecognitionError, SpeechRecognitionEvent, SpeechSynthesisEvent, StorageEvent, StyleElement, TableCaptionElement, TableCellElement, TableColElement, TableElement, TableRowElement, TableSectionElement, TemplateElement, Text, TextAreaElement, TextEvent, TitleElement, TouchEvent, TrackElement, TrackEvent, TransitionEvent, UIEvent, UListElement, UnknownElement, VideoElement, WheelEvent, Window, XmlDocument, _Attr, _DocumentType, _HTMLAppletElement, _HTMLDirectoryElement, _HTMLFontElement, _HTMLFrameElement, _HTMLFrameSetElement, _HTMLMarqueeElement, _MutationEvent, _Notation, _XMLHttpRequestProgressEvent, VersionChangeEvent, AElement, AltGlyphElement, AnimateElement, AnimateMotionElement, AnimateTransformElement, AnimatedNumberList, AnimatedString, AnimationElement, CircleElement, ClipPathElement, DefsElement, DescElement, DiscardElement, EllipseElement, FEBlendElement, FEColorMatrixElement, FEComponentTransferElement, FECompositeElement, FEConvolveMatrixElement, FEDiffuseLightingElement, FEDisplacementMapElement, FEDistantLightElement, FEFloodElement, FEFuncAElement, FEFuncBElement, FEFuncGElement, FEFuncRElement, FEGaussianBlurElement, FEImageElement, FEMergeElement, FEMergeNodeElement, FEMorphologyElement, FEOffsetElement, FEPointLightElement, FESpecularLightingElement, FESpotLightElement, FETileElement, FETurbulenceElement, FilterElement, ForeignObjectElement, GElement, GeometryElement, GraphicsElement, ImageElement0, LineElement, LinearGradientElement, MarkerElement, MaskElement, MetadataElement, PathElement, PatternElement, PolygonElement, PolylineElement, RadialGradientElement, RectElement, ScriptElement0, SetElement, StopElement, StyleElement0, SvgElement, SvgSvgElement, SwitchElement, SymbolElement, TSpanElement, TextContentElement, TextElement, TextPathElement, TextPositioningElement, TitleElement0, UseElement, ViewElement, ZoomEvent, _GradientElement, _SVGAltGlyphDefElement, _SVGAltGlyphItemElement, _SVGComponentTransferFunctionElement, _SVGCursorElement, _SVGFEDropShadowElement, _SVGFontElement, _SVGFontFaceElement, _SVGFontFaceFormatElement, _SVGFontFaceNameElement, _SVGFontFaceSrcElement, _SVGFontFaceUriElement, _SVGGlyphElement, _SVGGlyphRefElement, _SVGHKernElement, _SVGMPathElement, _SVGMissingGlyphElement, _SVGVKernElement, AudioProcessingEvent, OfflineAudioCompletionEvent, ContextEvent, SqlError, NativeByteBuffer, NativeTypedData, NativeByteData, NativeFloat32List, NativeFloat64List, NativeInt16List, NativeInt32List, NativeInt8List, NativeUint16List, NativeUint32List, NativeUint8ClampedList, NativeUint8List, JS_CONST, Interceptor, JSBool, JSNull, JavaScriptObject, PlainJavaScriptObject, UnknownJavaScriptObject, JSArray, JSNumber, JSInt, JSDouble, JSString, startRootIsolate_closure, startRootIsolate_closure0, _Manager, _IsolateContext, _IsolateContext_handlePing_respond, _EventLoop, _EventLoop__runHelper_next, _IsolateEvent, _MainManagerStub, IsolateNatives__processWorkerMessage_closure, IsolateNatives__processWorkerMessage_closure0, IsolateNatives__processWorkerMessage_closure1, IsolateNatives_spawn_closure, IsolateNatives_spawn_closure0, IsolateNatives__startNonWorker_closure, IsolateNatives__startIsolate_runStartFunction, _BaseSendPort, _NativeJsSendPort, _NativeJsSendPort_send_closure, _WorkerSendPort, RawReceivePortImpl, ReceivePortImpl, _JsSerializer, _JsCopier, _JsDeserializer, _JsVisitedMap, _MessageTraverserVisitedMap, _MessageTraverser, _Copier, _Copier_visitMap_closure, _Serializer, _Deserializer, TimerImpl, TimerImpl_internalCallback, TimerImpl_internalCallback0, CapabilityImpl, JSInvocationMirror, ReflectionInfo, ReflectionInfo_sortedIndex_closure, Primitives_functionNoSuchMethod_closure, Primitives_applyFunction_closure, TypeErrorDecoder, NullError, JsNoSuchMethodError, UnknownJsTypeError, unwrapException_saveStackTrace, _StackTrace, invokeClosure_closure, invokeClosure_closure0, invokeClosure_closure1, invokeClosure_closure2, invokeClosure_closure3, Closure, TearOffClosure, BoundClosure, RuntimeError, RuntimeType, RuntimeFunctionType, DynamicRuntimeType, TypeImpl, initHooks_closure, initHooks_closure0, initHooks_closure1, JSSyntaxRegExp, CanvasBasics_register_closure, CanvasBasics_register__closure, CanvasBasics_register___closure4, CanvasBasics_register___closure5, CanvasBasics_register__closure0, CanvasBasics_register___closure, CanvasBasics_register___closure0, CanvasBasics_register___closure1, CanvasBasics_register___closure2, CanvasBasics_register___closure3, ListIterator, MappedIterable, EfficientLengthMappedIterable, MappedIterator, FixedLengthListMixin, Symbol0, _AsyncRun__scheduleImmediateJsOverride_internalCallback, _AsyncError, Future, Future_wait_handleError, Future_wait_closure, _Completer, _AsyncCompleter, _Future, _Future__addListener_closure, _Future__chainForeignFuture_closure, _Future__chainForeignFuture_closure0, _Future__asyncComplete_closure, _Future__asyncComplete_closure0, _Future__asyncCompleteError_closure, _Future__propagateToListeners_handleValueCallback, _Future__propagateToListeners_handleError, _Future__propagateToListeners_handleWhenCompleteCallback, _Future__propagateToListeners_handleWhenCompleteCallback_closure, _Future__propagateToListeners_handleWhenCompleteCallback_closure0, _AsyncCallbackEntry, Stream, Stream_forEach_closure, Stream_forEach__closure, Stream_forEach__closure0, Stream_forEach_closure0, Stream_length_closure, Stream_length_closure0, Stream_isEmpty_closure, Stream_isEmpty_closure0, Stream_first_closure, Stream_first_closure0, StreamSubscription, _StreamController, _StreamController__subscribe_closure, _StreamController__recordCancel_complete, _SyncStreamControllerDispatch, _AsyncStreamControllerDispatch, _AsyncStreamController, _StreamController__AsyncStreamControllerDispatch, _SyncStreamController, _StreamController__SyncStreamControllerDispatch, _ControllerStream, _ControllerSubscription, _EventSink, _BufferingStreamSubscription, _BufferingStreamSubscription__sendDone_sendDone, _StreamImpl, _DelayedEvent, _DelayedData, _DelayedDone, _PendingEvents, _PendingEvents_schedule_closure, _StreamImplEvents, _cancelAndError_closure, _cancelAndErrorClosure_closure, _cancelAndValue_closure, _BaseZone, _BaseZone_bindCallback_closure, _BaseZone_bindCallback_closure0, _rootHandleUncaughtError_closure, _rootHandleUncaughtError__closure, _RootZone, _HashMap, _HashMap_values_closure, HashMapKeyIterable, HashMapKeyIterator, _LinkedHashMap, _LinkedHashMap_values_closure, _LinkedHashMap_addAll_closure, LinkedHashMapCell, LinkedHashMapKeyIterable, LinkedHashMapKeyIterator, _LinkedHashSet, LinkedHashSetCell, LinkedHashSetIterator, _HashSetBase, IterableBase, ListMixin, Maps_mapToString_closure, ListQueue, _ListQueueIterator, SetMixin, SetBase, Function__toMangledNames_closure, NoSuchMethodError_toString_closure, bool, Comparable, DateTime, $double, Duration, Duration_toString_sixDigits, Duration_toString_twoDigits, Error, NullThrownError, ArgumentError, RangeError, NoSuchMethodError, UnsupportedError, UnimplementedError, StateError, ConcurrentModificationError, StackOverflowError, CyclicInitializationError, _ExceptionImplementation, FormatException, IntegerDivisionByZeroException, Expando, Function, $int, Iterator, List, Map, Null, num, Object, StackTrace, String, StringBuffer, Symbol, Interceptor_ListMixin, Interceptor_ListMixin_ImmutableListMixin, ImmutableListMixin, FixedSizeListIterator, Capability, _JSRandom, Uint8List, NativeTypedArray, NativeTypedArrayOfDouble, NativeTypedArray_ListMixin, NativeTypedArray_ListMixin_FixedLengthListMixin, NativeTypedArrayOfInt, NativeTypedArray_ListMixin0, NativeTypedArray_ListMixin_FixedLengthListMixin0, Counter, DS, dsFilter, dsAbstractNode, dsAbstractList, dsGSearcher, dsGArc, dsGNode, dsAbstractGraph, dsAbstractIterator, dsAbstractIterator_moveNext_closure, dsAbstractIterator_moveNext_closure0, dsAbstractIterator_moveNext_closure1, GraphFilter, GraphFilter_filter_closure, dsDepthFirst, dsBreadthFirst, dsGraph, dsGraphArc, dsGraphNode, dsGraphNode_addArc_closure, dsGraphNode_removeArc_closure, dsGraphNode_arcFinder_closure, dsIterator, dsListIterator, dsList, dsNode, convertNativeToDart_AcceptStructuredClone_findSlot, convertNativeToDart_AcceptStructuredClone_readSlot, convertNativeToDart_AcceptStructuredClone_writeSlot, convertNativeToDart_AcceptStructuredClone_walk, Enums_nthFor_closure, Enums_nthFor_closure0, Enums_eachAsyncList_closure, Enums_eachAsyncMap_closure, Enums_eachSyncList_closure, Enums_eachSyncList__closure, Enums_eachSyncList_closure0, Enums_merge_closure, Enums_filterKeys_closure, Enums_filterKeys_closure0, Switch, Distributor0, Distributor_fireOncers_closure, Distributor_fireDone_closure, Mutator, Mutator_fireListeners_closure0, Mutator_fireListeners_closure, Condition, Condition_fireConditions_closure, Condition_fireConditions_closure0, Condition_fireDone_closure, Condition_fireOnce_closure, Condition_fireOnce_closure0, MapDecorator, Counter0, State, State_closure, State__closure, StateManager, StateManager_close_closure, Funcs_tagDefer_closure, Funcs_tagPrint_closure, Funcs_base10Functionator_closure, Funcs_base10Functionator_closure0, Funcs_base10Functionator_closure1, Funcs_base10Functionator_closure2, Funcs_base10Functionator_closure3, Funcs_base10Functionator_closure4, Funcs_base10Functionator_closure5, Funcs_base10Functionator_closure6, Funcs_base10Functionator_closure7, Funcs_base10Functionator_closure8, Funcs_compose_closure, Funcs_compose_closure0, Funcs_compose__closure7, Funcs_compose_closure1, Funcs_compose__closure6, Funcs_compose_closure2, Funcs_compose__closure5, Funcs_compose_closure3, Funcs_compose__closure4, Funcs_compose_closure4, Funcs_compose__closure3, Funcs_compose_closure5, Funcs_compose__closure2, Funcs_compose_closure6, Funcs_compose__closure1, Funcs_compose_closure7, Funcs_compose__closure0, Funcs_compose_closure8, Funcs_compose__closure, Hub_randomStringsets_closure, Hub_encryptNamedArguments_closure, PacketList, Packet, SparkRegistry, SparkRegistry_addMutation_closure, SparkRegistryManager, FlowSocket, FlowPort, FlowComponentAbstract, FlowNetworkAbstract, FlowNetwork, FlowComponent, toIP_closure, SocketStream, Socket, closure1, closure2, Socket_forceCondition_closure, Port, Port_handleAliasCall_closure, Port_send_closure, Port_beginGroup_closure, Port_endGroup_closure, Port_tapData_closure, Port_tapData__closure, InPortType, OutportType, Inport, Outport, PlaceHolder, FutureCompiler, FutureCompiler_generateFutureList_closure, FutureCompiler_generateFutureList_closure0, Network, closure, closure0, Network_closure, Network_closure0, Network_closure1, Network_closure2, Network_closure3, Network_closure4, Network_closure5, Network_closure6, Network_closure7, Network_closure8, Network_close_closure, Network_close_closure0, Network_filterDF_closure, Network_filterDF_closure0, Network__runBootUpScheduledPackets_closure, Network__runBootUpScheduledPackets__closure, Network__runScheduledPackets_closure, Network__runScheduledPackets_closure0, Network_destroy_closure, Network_remove_closure, Network_remove_closure0, Network_shutdown_closure, Network_shutdown__closure, Network_shutdown__closure0, Network_shutdown_closure0, Network_boot_closure, Network_boot__closure, Network_boot__closure0, Network_boot_closure0, Network_ensureBinding_closure, Network_link_closure, Network_link__closure, Network_doBinding_closure, Network_doBinding__closure, Network_doBinding__closure0, Network_doBinding_closure0, Network_doBinding_closure1, Network_doBinding_closure2, Network_doBinding_closure3, Network_connect_closure, Network_connect__closure, Network_connect__closure0, Network_loopPorts_closure, ConnectionMeta, ConnectionMeta_filterUUIDPort_closure, ConnectionMeta_addConnection_closure, ConnectionMeta_removeConnection_closure, ConnectionMeta_removeConnection__closure, PortGroup, PortGroup_addInport_closure, PortGroup_addOutPort_closure, PortGroup_close_closure, PortGroup_pauseAll_closure, PortGroup_flushAll_closure, PortManager, PortManager_destroyAllSpaces_closure, PortManager_flushAllPackets_closure, PortManager_pauseAll_closure, Component, Component_closure, Component_closure0, Component_closure1, Component_closure2, Component_closure3, Component_closure4, Component_closure5, Component_closure6, Component_closure7, Component_closure8, Component__closure, Component__closure0, Component_boot_closure, Component_shutdown_closure, Component_close_closure, MassTree, ComponentGroup, ComponentGroup_add_closure, SparkGroups, Streamer, Listener, Distributor, Streamable, Streamable_closure, Streamable_closure0, Streamable_closure1, Streamable_closure2, Streamable_closure3, Streamable_closure4, Streamable_closure5, Streamable_closure6, Streamable_closure7, Streamable_closure8, Streamable_closure9, Streamable_closure10, Streamable_closure11, Streamable_closure12, Streamable_closure13, Streamable_closure14, Streamable_closure15, Streamable_closure16, Streamable_closure17, Streamable_closure18, Streamable_closure19, Streamable_closure20, Streamable_closure21, Streamable_closure22, Streamable_closure23, Streamable_closure24, Streamable_closure25, Streamable_closure26, Streamable_closure27, Streamable_closure28, Streamable_closure29, Streamable_closure30, Streamable_closure31, Streamable_closure32, Subscriber, Subscriber_closure, Subscriber_closure0, Subscriber_closure1];
}
